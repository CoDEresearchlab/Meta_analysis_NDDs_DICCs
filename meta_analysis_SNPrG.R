...
REM0.5_childhood_rA <- NA                   
REM0.5_middlechildhood_rA <- NA             
REM0.5_adolescence_rA <- NA                 
REM0.5_childhood_middlechildhood_rA <- NA   
REM0.5_childhood_adolescence_rA <- NA       
REM0.5_middlechildhood_adolescence_rA <- NA 
REM0.5_sibling_categorical_rA <- NA         
REM0.5_sibling_classical_rA <- NA           
REM0.5_twin_and_sibling_categorical_rA <- NA
REM0.5_twin_and_sibling_dfextremes_rA <- NA 
REM0.5_twin_and_sibling_classical_rA <- NA  
REM0.5_twin_categorical_rA <- NA            
REM0.5_twin_dfextremes_rA <- NA             
REM0.5_twin_classical_rA <- NA              
REM0.5_Aonly_rA <- NA                       
REM0.5_BEST_rA <- NA                        
REM0.5_FULL_rA <- NA                        
REM0.5_DFAonly_rA <- NA                     
REM0.5_DFBEST_rA <- NA                      
REM0.5_DFFULL_rA <- NA                      
REM0.5_TC_rA <- NA                          
REM0.5_diagnosis_rA <- NA                   
REM0.5_parent_rA <- NA                      
REM0.5_parent_self_rA <- NA                 
REM0.5_parent_teacher_rA <- NA              
REM0.5_researcher_rA <- NA                  
REM0.5_self_rA <- NA                        
REM0.5_teacher_rA <- NA                     
REM0.5_test_rA <- NA                        
REM0.5_categorical_rA <- NA                 
REM0.5_continuous_rA <- NA                  
REM0.5_50_rA <- NA                          
REM0.5_50_75_rA <- NA                       
REM0.5_75_100_rA <- NA                      
REM0.5_100_rA <- NA                         
...
REM0.5_3_rA <- NA                           
REM0.5_4_rA <- NA                           
REM0.5_Australia_rA <- NA                   
REM0.5_Aus_USA_Nor_Swe_rA <- NA             
REM0.5_Canada_rA <- NA                      
REM0.5_China_rA <- NA                       
REM0.5_Netherlands_rA <- NA                 
REM0.5_Norway_rA <- NA                      
REM0.5_Sweden_rA <- NA                      
REM0.5_UK_rA <- NA                          
REM0.5_USA_rA <- NA    
...
# ============= Compute effect size and variance -- Converting rA into Fisher's Z ==========================
# ============= Treat rA as correlation and convert to Fisher's Z (SE will be used as variance) =============
...
datMeta_agg0.5 <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta)
datMeta_agg0.3 <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.3, data=datMeta)
datMeta_agg0.9 <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.9, data=datMeta)
...
# Extract grand rA
REM0.5_nocov_rA <- fisherz2r(coef(REM0.5_nocov))
names(REM0.5_nocov_rA) <- NULL
REM0.5_nocov_rA

REM0.3_nocov_rA <- fisherz2r(coef(REM0.3_nocov))
names(REM0.3_nocov_rA) <- NULL
REM0.3_nocov_rA

REM0.9_nocov_rA <- fisherz2r(coef(REM0.9_nocov))
names(REM0.9_nocov_rA) <- NULL
REM0.9_nocov_rA

cbind(REM0.5_nocov_rA, REM0.3_nocov_rA, REM0.9_nocov_rA) #No difference :)
...
datMeta_agg0.5_cohort <- agg(id=Cohort, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta)
datMeta_agg0.3_cohort <- agg(id=Cohort, es=FZ_rA, var=rA_SE, cor=0.3, data=datMeta)
datMeta_agg0.9_cohort <- agg(id=Cohort, es=FZ_rA, var=rA_SE, cor=0.9, data=datMeta)
...
# Extract grand rA
REM0.5_cohort_nocov_rA <- fisherz2r(coef(REM0.5_cohort_nocov))
names(REM0.5_cohort_nocov_rA) <- NULL
REM0.5_cohort_nocov_rA

REM0.3_cohort_nocov_rA <- fisherz2r(coef(REM0.3_cohort_nocov))
names(REM0.3_cohort_nocov_rA) <- NULL
REM0.3_cohort_nocov_rA

REM0.9_cohort_nocov_rA <- fisherz2r(coef(REM0.9_cohort_nocov))
names(REM0.9_cohort_nocov_rA) <- NULL
REM0.9_cohort_nocov_rA

cbind(REM0.5_cohort_nocov_rA, REM0.3_cohort_nocov_rA, REM0.9_cohort_nocov_rA) #No difference :)
...
datMeta_agg0.5_country <- agg(id=Cohort_country1, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta)
datMeta_agg0.3_country <- agg(id=Cohort_country1, es=FZ_rA, var=rA_SE, cor=0.3, data=datMeta)
datMeta_agg0.9_country <- agg(id=Cohort_country1, es=FZ_rA, var=rA_SE, cor=0.9, data=datMeta)
...
# Extract grand rA
REM0.5_country_nocov_rA <- fisherz2r(coef(REM0.5_country_nocov))
names(REM0.5_country_nocov_rA) <- NULL
REM0.5_country_nocov_rA

REM0.3_country_nocov_rA <- fisherz2r(coef(REM0.3_country_nocov))
names(REM0.3_country_nocov_rA) <- NULL
REM0.3_country_nocov_rA

REM0.9_country_nocov_rA <- fisherz2r(coef(REM0.9_country_nocov))
names(REM0.9_country_nocov_rA) <- NULL
REM0.9_country_nocov_rA

cbind(REM0.5_country_nocov_rA, REM0.3_country_nocov_rA, REM0.9_country_nocov_rA) #No difference :)
...
datMeta_agg0.5_childhood <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_childhood)
...
# Extract grand rA
REM0.5_childhood_rA <- fisherz2r(coef(REM0.5_childhood))
names(REM0.5_childhood_rA) <- NULL
REM0.5_childhood_rA
...
datMeta_agg0.5_middlechildhood <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_middlechildhood)
...
# Extract grand rA
REM0.5_middlechildhood_rA <- fisherz2r(coef(REM0.5_middlechildhood))
names(REM0.5_middlechildhood_rA) <- NULL
REM0.5_middlechildhood_rA
...
datMeta_agg0.5_adolescence <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_adolescence)
...
# Extract grand rA
REM0.5_adolescence_rA <- fisherz2r(coef(REM0.5_adolescence))
names(REM0.5_adolescence_rA) <- NULL
REM0.5_adolescence_rA
...
datMeta_agg0.5_childhood_middlechildhood <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_childhood_middlechildhood)
...
# Extract grand rA
REM0.5_childhood_middlechildhood_rA <- fisherz2r(coef(REM0.5_childhood_middlechildhood))
names(REM0.5_childhood_middlechildhood_rA) <- NULL
REM0.5_childhood_middlechildhood_rA
...
datMeta_agg0.5_middlechildhood_adolescence <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_middlechildhood_adolescence)
...
# Extract grand rA
REM0.5_middlechildhood_adolescence_rA <- fisherz2r(coef(REM0.5_middlechildhood_adolescence))
names(REM0.5_middlechildhood_adolescence_rA) <- NULL
REM0.5_middlechildhood_adolescence_rA
...
datMeta_agg0.5_childhood_adolescence <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_childhood_adolescence)
...
# Extract grand rA
REM0.5_childhood_adolescence_rA <- fisherz2r(coef(REM0.5_childhood_adolescence))
names(REM0.5_childhood_adolescence_rA) <- NULL
REM0.5_childhood_adolescence_rA
...
ages_rA <- rbind(REM0.5_childhood_rA,
                 REM0.5_middlechildhood_rA,
                 REM0.5_adolescence_rA,
                 REM0.5_childhood_middlechildhood_rA,
                 REM0.5_childhood_adolescence_rA,
...
ages <- cbind(ages_rA, ages_se, ages_k)
...
datMeta_agg0.5_sibling_categorical <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_sibling_categorical)
...
# Extract grand rA
REM0.5_sibling_categorical_rA <- fisherz2r(coef(REM0.5_sibling_categorical))
names(REM0.5_sibling_categorical_rA) <- NULL
REM0.5_sibling_categorical_rA
...
datMeta_agg0.5_sibling_classical <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_sibling_classical)
...
# Extract grand rA
REM0.5_sibling_classical_rA <- fisherz2r(coef(REM0.5_sibling_classical))
names(REM0.5_sibling_classical_rA) <- NULL
REM0.5_sibling_classical_rA
...
datMeta_agg0.5_twin_and_sibling_categorical <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_twin_and_sibling_categorical)
...
# Extract grand rA
REM0.5_twin_and_sibling_categorical_rA <- fisherz2r(coef(REM0.5_twin_and_sibling_categorical))
names(REM0.5_twin_and_sibling_categorical_rA) <- NULL
REM0.5_twin_and_sibling_categorical_rA
...
datMeta_agg0.5_twin_and_sibling_classical <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_twin_and_sibling_classical)
...
# Extract grand rA
REM0.5_twin_and_sibling_classical_rA <- fisherz2r(coef(REM0.5_twin_and_sibling_classical))
names(REM0.5_twin_and_sibling_classical_rA) <- NULL
REM0.5_twin_and_sibling_classical_rA
...
datMeta_agg0.5_twin_and_sibling_dfextremes <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_twin_and_sibling_dfextremes)
...
# Extract grand rA
REM0.5_twin_and_sibling_dfextremes_rA <- fisherz2r(coef(REM0.5_twin_and_sibling_dfextremes))
names(REM0.5_twin_and_sibling_dfextremes_rA) <- NULL
REM0.5_twin_and_sibling_dfextremes_rA
...
datMeta_agg0.5_twin_categorical <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_twin_categorical)
...
# Extract grand rA
REM0.5_twin_categorical_rA <- fisherz2r(coef(REM0.5_twin_categorical))
names(REM0.5_twin_categorical_rA) <- NULL
REM0.5_twin_categorical_rA
...
datMeta_agg0.5_twin_classical <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_twin_classical)
...
# Extract grand rA
REM0.5_twin_classical_rA <- fisherz2r(coef(REM0.5_twin_classical))
names(REM0.5_twin_classical_rA) <- NULL
REM0.5_twin_classical_rA
...
datMeta_agg0.5_twin_dfextremes <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_twin_dfextremes)
...
# Extract grand rA
REM0.5_twin_dfextremes_rA <- fisherz2r(coef(REM0.5_twin_dfextremes))
names(REM0.5_twin_dfextremes_rA) <- NULL
REM0.5_twin_dfextremes_rA
...
designs_rA <- rbind(REM0.5_sibling_categorical_rA,
                    REM0.5_sibling_classical_rA,
                    REM0.5_twin_and_sibling_categorical_rA,
                    REM0.5_twin_and_sibling_dfextremes_rA,
                    REM0.5_twin_and_sibling_classical_rA,
...
designs <- cbind(designs_rA, designs_se, designs_k)
designs
...
datMeta_agg0.5_Aonly <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_Aonly)
...
# Extract grand rA
REM0.5_Aonly_rA <- fisherz2r(coef(REM0.5_Aonly))
names(REM0.5_Aonly_rA) <- NULL
REM0.5_Aonly_rA
...
datMeta_agg0.5_BEST <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_BEST)
...
# Extract grand rA
REM0.5_BEST_rA <- fisherz2r(coef(REM0.5_BEST))
names(REM0.5_BEST_rA) <- NULL
REM0.5_BEST_rA
...
datMeta_agg0.5_DFAonly <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_DFAonly)
...
# Extract grand rA
REM0.5_DFAonly_rA <- fisherz2r(coef(REM0.5_DFAonly))
names(REM0.5_DFAonly_rA) <- NULL
REM0.5_DFAonly_rA
...
datMeta_agg0.5_DFBEST <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_DFBEST)
...
# Extract grand rA
REM0.5_DFBEST_rA <- fisherz2r(coef(REM0.5_DFBEST))
names(REM0.5_DFBEST_rA) <- NULL
REM0.5_DFBEST_rA
...
datMeta_agg0.5_DFFULL <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_DFFULL)
...
# Extract grand rA
REM0.5_DFFULL_rA <- fisherz2r(coef(REM0.5_DFFULL))
names(REM0.5_DFFULL_rA) <- NULL
REM0.5_DFFULL_rA
...
datMeta_agg0.5_FULL <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_FULL)
...
# Extract grand rA
REM0.5_FULL_rA <- fisherz2r(coef(REM0.5_FULL))
names(REM0.5_FULL_rA) <- NULL
REM0.5_FULL_rA
...
datMeta_agg0.5_TC <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_TC)
...
# Extract grand rA
REM0.5_TC_rA <- fisherz2r(coef(REM0.5_TC))
names(REM0.5_TC_rA) <- NULL
REM0.5_TC_rA
...
models_rA <- rbind(REM0.5_Aonly_rA,
                   REM0.5_BEST_rA,
                   REM0.5_FULL_rA,
                   REM0.5_DFAonly_rA,
                   REM0.5_DFBEST_rA,
...
models <- cbind(models_rA, models_se, models_k)
models
...
datMeta_agg0.5_diagnosis <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_diagnosis)
...
# Extract grand rA
REM0.5_diagnosis_rA <- fisherz2r(coef(REM0.5_diagnosis))
names(REM0.5_diagnosis_rA) <- NULL
REM0.5_diagnosis_rA
...
datMeta_agg0.5_parent <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_parent)
...
# Extract grand rA
REM0.5_parent_rA <- fisherz2r(coef(REM0.5_parent))
names(REM0.5_parent_rA) <- NULL
REM0.5_parent_rA
...
datMeta_agg0.5_parent_self <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_parent_self)
...
# Extract grand rA
REM0.5_parent_self_rA <- fisherz2r(coef(REM0.5_parent_self))
names(REM0.5_parent_self_rA) <- NULL
REM0.5_parent_self_rA
...
datMeta_agg0.5_parent_teacher <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_parent_teacher)
...
# Extract grand rA
REM0.5_parent_teacher_rA <- fisherz2r(coef(REM0.5_parent_teacher))
names(REM0.5_parent_teacher_rA) <- NULL
REM0.5_parent_teacher_rA
...
datMeta_agg0.5_researcher <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_researcher)
...
# Extract grand rA
REM0.5_researcher_rA <- fisherz2r(coef(REM0.5_researcher))
names(REM0.5_researcher_rA) <- NULL
REM0.5_researcher_rA
...
datMeta_agg0.5_self <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_self)
...
# Extract grand rA
REM0.5_self_rA <- fisherz2r(coef(REM0.5_self))
names(REM0.5_self_rA) <- NULL
REM0.5_self_rA
...
datMeta_agg0.5_teacher <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_teacher)
...
# Extract grand rA
REM0.5_teacher_rA <- fisherz2r(coef(REM0.5_teacher))
names(REM0.5_teacher_rA) <- NULL
REM0.5_teacher_rA
...
datMeta_agg0.5_test <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_test)
...
# Extract grand rA
REM0.5_test_rA <- fisherz2r(coef(REM0.5_test))
names(REM0.5_test_rA) <- NULL
REM0.5_test_rA
...
raters_rA <- rbind(REM0.5_diagnosis_rA,
                   REM0.5_parent_rA,
                   REM0.5_parent_self_rA,
                   REM0.5_parent_teacher_rA,
                   REM0.5_researcher_rA,
...
raters <- cbind(raters_rA, raters_se, raters_k)
...
datMeta_agg0.5_categorical <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_categorical)
...
# Extract grand rA
REM0.5_categorical_rA <- fisherz2r(coef(REM0.5_categorical))
names(REM0.5_categorical_rA) <- NULL
REM0.5_categorical_rA
...
datMeta_agg0.5_continuous <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_continuous)
...
# Extract grand rA
REM0.5_continuous_rA <- fisherz2r(coef(REM0.5_continuous))
names(REM0.5_continuous_rA) <- NULL
REM0.5_continuous_rA
...
scales_rA <- rbind(REM0.5_categorical_rA,
                   REM0.5_continuous_rA)
...
scales <- cbind(scales_rA, scales_se, scales_k)
scales
...
datMeta_agg0.5_50 <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_50)
...
# Extract grand rA
REM0.5_50_rA <- fisherz2r(coef(REM0.5_50))
names(REM0.5_50_rA) <- NULL
REM0.5_50_rA
...
datMeta_agg0.5_50_75 <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_50_75)
...
# Extract grand rA
REM0.5_50_75_rA <- fisherz2r(coef(REM0.5_50_75))
names(REM0.5_50_75_rA) <- NULL
REM0.5_50_75_rA
...
datMeta_agg0.5_75_100 <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_75_100)
...
# Extract grand rA
REM0.5_75_100_rA <- fisherz2r(coef(REM0.5_75_100))
names(REM0.5_75_100_rA) <- NULL
REM0.5_75_100_rA
...
datMeta_agg0.5_100 <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_100)
...
# Extract grand rA
REM0.5_100_rA <- fisherz2r(coef(REM0.5_100))
names(REM0.5_100_rA) <- NULL
REM0.5_100_rA
...
ethnicities_rA <- rbind(REM0.5_50_rA,
                        REM0.5_50_75_rA,
                        REM0.5_75_100_rA,
                        REM0.5_100_rA)
...
ethnicities <- cbind(ethnicities_rA, ethnicities_se, ethnicities_k)
ethnicities
...
datMeta_agg0.5_0 <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_0)
...
# Extract grand rA
REM0.5_0_rA <- fisherz2r(coef(REM0.5_0))
names(REM0.5_0_rA) <- NULL
REM0.5_0_rA
...
datMeta_agg0.5_1 <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_1)
...
# Extract grand rA
REM0.5_1_rA <- fisherz2r(coef(REM0.5_1))
names(REM0.5_1_rA) <- NULL
REM0.5_1_rA
...
datMeta_agg0.5_2 <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_2)
...
# Extract grand rA
REM0.5_2_rA <- fisherz2r(coef(REM0.5_2))
names(REM0.5_2_rA) <- NULL
REM0.5_2_rA
...
datMeta_agg0.5_3 <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_3)
...
# Extract grand rA
REM0.5_3_rA <- fisherz2r(coef(REM0.5_3))
names(REM0.5_3_rA) <- NULL
REM0.5_3_rA
...
datMeta_agg0.5_4 <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_4)
...
# Extract grand rA
REM0.5_4_rA <- fisherz2r(coef(REM0.5_4))
names(REM0.5_4_rA) <- NULL
REM0.5_4_rA
...
nocovs <- cbind(nocovs_rA, nocovs_se, nocovs_k)
nocovs
...
datMeta_agg0.5_Australia <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_Australia)
...
# Extract grand rA
REM0.5_Australia_rA <- fisherz2r(coef(REM0.5_Australia))
names(REM0.5_Australia_rA) <- NULL
REM0.5_Australia_rA
...
datMeta_agg0.5_Aus_USA_Nor_Swe <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_Aus_USA_Nor_Swe)
...
# Extract grand rA
REM0.5_Aus_USA_Nor_Swe_rA <- fisherz2r(coef(REM0.5_Aus_USA_Nor_Swe))
names(REM0.5_Aus_USA_Nor_Swe_rA) <- NULL
REM0.5_Aus_USA_Nor_Swe_rA
...
datMeta_agg0.5_Canada <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_Canada)
...
# Extract grand rA
REM0.5_Canada_rA <- fisherz2r(coef(REM0.5_Canada))
names(REM0.5_Canada_rA) <- NULL
REM0.5_Canada_rA
...
datMeta_agg0.5_China <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_China)
...
# Extract grand rA
REM0.5_China_rA <- fisherz2r(coef(REM0.5_China))
names(REM0.5_China_rA) <- NULL
REM0.5_China_rA
...
datMeta_agg0.5_Netherlands <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_Netherlands)
...
# Extract grand rA
REM0.5_Netherlands_rA <- fisherz2r(coef(REM0.5_Netherlands))
names(REM0.5_Netherlands_rA) <- NULL
REM0.5_Netherlands_rA
...
datMeta_agg0.5_Norway <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_Norway)
...
# Extract grand rA
REM0.5_Norway_rA <- fisherz2r(coef(REM0.5_Norway))
names(REM0.5_Norway_rA) <- NULL
REM0.5_Norway_rA
...
datMeta_agg0.5_Sweden <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_Sweden)
...
# Extract grand rA
REM0.5_Sweden_rA <- fisherz2r(coef(REM0.5_Sweden))
names(REM0.5_Sweden_rA) <- NULL
REM0.5_Sweden_rA
...
datMeta_agg0.5_UK <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_UK)
...
# Extract grand rA
REM0.5_UK_rA <- fisherz2r(coef(REM0.5_UK))
names(REM0.5_UK_rA) <- NULL
REM0.5_UK_rA
...
datMeta_agg0.5_USA <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_USA)
...
# Extract grand rA
REM0.5_USA_rA <- fisherz2r(coef(REM0.5_USA))
names(REM0.5_USA_rA) <- NULL
REM0.5_USA_rA
...
countries_rA <- rbind(REM0.5_Australia_rA,
                      REM0.5_Aus_USA_Nor_Swe_rA,
                      REM0.5_Canada_rA,
                      REM0.5_China_rA,
                      REM0.5_Netherlands_rA,
...
countries <- cbind(countries_rA, countries_se, countries_k)
countries
...
datMeta_agg0.5_ADHD <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_ADHD)
...
# Extract grand rA
REM0.5_ADHD_rA <- fisherz2r(coef(REM0.5_ADHD))
names(REM0.5_ADHD_rA) <- NULL
REM0.5_ADHD_rA
...
datMeta_agg0.5_ASD <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_ASD)
...
# Extract grand rA
REM0.5_ASD_rA <- fisherz2r(coef(REM0.5_ASD))
names(REM0.5_ASD_rA) <- NULL
REM0.5_ASD_rA
...
datMeta_agg0.5_CMD <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_CMD)
...
# Extract grand rA
REM0.5_CMD_rA <- fisherz2r(coef(REM0.5_CMD))
names(REM0.5_CMD_rA) <- NULL
REM0.5_CMD_rA
...
datMeta_agg0.5_SLD <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_SLD)
...
# Extract grand rA
REM0.5_SLD_rA <- fisherz2r(coef(REM0.5_SLD))
names(REM0.5_SLD_rA) <- NULL
REM0.5_SLD_rA
...
datMeta_agg0.5_LD <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_LD)
...
# Extract grand rA
REM0.5_LD_rA <- fisherz2r(coef(REM0.5_LD))
names(REM0.5_LD_rA) <- NULL
REM0.5_LD_rA
...
datMeta_agg0.5_MD <- agg(id=Full.Ref, es=FZ_rA, var=rA_SE, cor=0.5, data=datMeta_MD)
...
# Extract grand rA
REM0.5_MD_rA <- fisherz2r(coef(REM0.5_MD))
names(REM0.5_MD_rA) <- NULL
REM0.5_MD_rA
...
disorders_rA <- rbind(REM0.5_SLD_rA,
                      REM0.5_ADHD_rA,
                      REM0.5_ASD_rA,
                      REM0.5_CMD_rA,
                      REM0.5_MD_rA,
...
disorders <- cbind(disorders_rA, disorders_se, disorders_k)
disorders
