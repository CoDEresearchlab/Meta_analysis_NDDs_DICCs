...
REM0.5_childhood_h2 <- NA                   
REM0.5_middlechildhood_h2 <- NA             
REM0.5_adolescence_h2 <- NA                 
REM0.5_childhood_middlechildhood_h2 <- NA   
REM0.5_childhood_adolescence_h2 <- NA       
REM0.5_middlechildhood_adolescence_h2 <- NA 
REM0.5_sibling_categorical_h2 <- NA         
REM0.5_sibling_classical_h2 <- NA           
REM0.5_twin_and_sibling_categorical_h2 <- NA
REM0.5_twin_and_sibling_dfextremes_h2 <- NA 
REM0.5_twin_and_sibling_classical_h2 <- NA  
REM0.5_twin_categorical_h2 <- NA            
REM0.5_twin_dfextremes_h2 <- NA             
REM0.5_twin_classical_h2 <- NA              
REM0.5_Aonly_h2 <- NA                       
REM0.5_BEST_h2 <- NA                        
REM0.5_FULL_h2 <- NA                        
REM0.5_DFAonly_h2 <- NA                     
REM0.5_DFBEST_h2 <- NA                      
REM0.5_DFFULL_h2 <- NA                      
REM0.5_TC_h2 <- NA                          
REM0.5_diagnosis_h2 <- NA                   
REM0.5_parent_h2 <- NA                      
REM0.5_parent_self_h2 <- NA                 
REM0.5_parent_teacher_h2 <- NA              
REM0.5_researcher_h2 <- NA                  
REM0.5_self_h2 <- NA                        
REM0.5_teacher_h2 <- NA                     
REM0.5_test_h2 <- NA                        
REM0.5_categorical_h2 <- NA                 
REM0.5_continuous_h2 <- NA                  
REM0.5_50_h2 <- NA                          
REM0.5_50_75_h2 <- NA                       
REM0.5_75_100_h2 <- NA                      
REM0.5_100_h2 <- NA                         
...
REM0.5_3_h2 <- NA                           
REM0.5_4_h2 <- NA                           
REM0.5_Australia_h2 <- NA                   
REM0.5_Aus_USA_Nor_Swe_h2 <- NA             
REM0.5_Canada_h2 <- NA                      
REM0.5_China_h2 <- NA                       
REM0.5_Netherlands_h2 <- NA                 
REM0.5_Norway_h2 <- NA                      
REM0.5_Sweden_h2 <- NA                      
REM0.5_UK_h2 <- NA                          
REM0.5_USA_h2 <- NA    
...
datMeta_agg0.3 <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.3, data=datMeta)
datMeta_agg0.9 <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.9, data=datMeta)
...
REM0.3_nocov_h2 <- fisherz2r(coef(REM0.3_nocov))
names(REM0.3_nocov_h2) <- NULL
REM0.3_nocov_h2

REM0.9_nocov_h2 <- fisherz2r(coef(REM0.9_nocov))
names(REM0.9_nocov_h2) <- NULL
REM0.9_nocov_h2

cbind(REM0.5_nocov_h2, REM0.3_nocov_h2, REM0.9_nocov_h2) #No difference :)
...
datMeta_agg0.5_cohort <- agg(id=Cohort, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta)
datMeta_agg0.3_cohort <- agg(id=Cohort, es=FZ_h2, var=h2_SE, cor=0.3, data=datMeta)
datMeta_agg0.9_cohort <- agg(id=Cohort, es=FZ_h2, var=h2_SE, cor=0.9, data=datMeta)
...
# Extract grand h2
REM0.5_cohort_nocov_h2 <- fisherz2r(coef(REM0.5_cohort_nocov))
names(REM0.5_cohort_nocov_h2) <- NULL
REM0.5_cohort_nocov_h2

REM0.3_cohort_nocov_h2 <- fisherz2r(coef(REM0.3_cohort_nocov))
names(REM0.3_cohort_nocov_h2) <- NULL
REM0.3_cohort_nocov_h2

REM0.9_cohort_nocov_h2 <- fisherz2r(coef(REM0.9_cohort_nocov))
names(REM0.9_cohort_nocov_h2) <- NULL
REM0.9_cohort_nocov_h2

cbind(REM0.5_cohort_nocov_h2, REM0.3_cohort_nocov_h2, REM0.9_cohort_nocov_h2) #No difference :)
...
datMeta_agg0.5_country <- agg(id=Cohort_country1, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta)
datMeta_agg0.3_country <- agg(id=Cohort_country1, es=FZ_h2, var=h2_SE, cor=0.3, data=datMeta)
datMeta_agg0.9_country <- agg(id=Cohort_country1, es=FZ_h2, var=h2_SE, cor=0.9, data=datMeta)
...
# Extract grand h2
REM0.5_country_nocov_h2 <- fisherz2r(coef(REM0.5_country_nocov))
names(REM0.5_country_nocov_h2) <- NULL
REM0.5_country_nocov_h2

REM0.3_country_nocov_h2 <- fisherz2r(coef(REM0.3_country_nocov))
names(REM0.3_country_nocov_h2) <- NULL
REM0.3_country_nocov_h2

REM0.9_country_nocov_h2 <- fisherz2r(coef(REM0.9_country_nocov))
names(REM0.9_country_nocov_h2) <- NULL
REM0.9_country_nocov_h2

cbind(REM0.5_country_nocov_h2, REM0.3_country_nocov_h2, REM0.9_country_nocov_h2) #No difference :)
...
datMeta_agg0.5_childhood <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_childhood)
...
# Extract grand h2
REM0.5_childhood_h2 <- fisherz2r(coef(REM0.5_childhood))
names(REM0.5_childhood_h2) <- NULL
REM0.5_childhood_h2
...
datMeta_agg0.5_middlechildhood <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_middlechildhood)
...
# Extract grand h2
REM0.5_middlechildhood_h2 <- fisherz2r(coef(REM0.5_middlechildhood))
names(REM0.5_middlechildhood_h2) <- NULL
REM0.5_middlechildhood_h2
...
datMeta_agg0.5_adolescence <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_adolescence)
...
# Extract grand h2
REM0.5_adolescence_h2 <- fisherz2r(coef(REM0.5_adolescence))
names(REM0.5_adolescence_h2) <- NULL
REM0.5_adolescence_h2
...
datMeta_agg0.5_childhood_middlechildhood <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_childhood_middlechildhood)
...
# Extract grand h2
REM0.5_childhood_middlechildhood_h2 <- fisherz2r(coef(REM0.5_childhood_middlechildhood))
names(REM0.5_childhood_middlechildhood_h2) <- NULL
REM0.5_childhood_middlechildhood_h2
...
datMeta_agg0.5_middlechildhood_adolescence <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_middlechildhood_adolescence)
...
# Extract grand h2
REM0.5_middlechildhood_adolescence_h2 <- fisherz2r(coef(REM0.5_middlechildhood_adolescence))
names(REM0.5_middlechildhood_adolescence_h2) <- NULL
REM0.5_middlechildhood_adolescence_h2
...
datMeta_agg0.5_childhood_adolescence <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_childhood_adolescence)
...
# Extract grand h2
REM0.5_childhood_adolescence_h2 <- fisherz2r(coef(REM0.5_childhood_adolescence))
names(REM0.5_childhood_adolescence_h2) <- NULL
REM0.5_childhood_adolescence_h2
...
ages_h2 <- rbind(REM0.5_childhood_h2,
                 REM0.5_middlechildhood_h2,
                 REM0.5_adolescence_h2,
                 REM0.5_childhood_middlechildhood_h2,
                 REM0.5_childhood_adolescence_h2,
...
ages <- cbind(ages_h2, ages_se, ages_k)
...
datMeta_agg0.5_sibling_categorical <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_sibling_categorical)
...
# Extract grand h2
REM0.5_sibling_categorical_h2 <- fisherz2r(coef(REM0.5_sibling_categorical))
names(REM0.5_sibling_categorical_h2) <- NULL
REM0.5_sibling_categorical_h2
...
datMeta_agg0.5_sibling_classical <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_sibling_classical)
...
# Extract grand h2
REM0.5_sibling_classical_h2 <- fisherz2r(coef(REM0.5_sibling_classical))
names(REM0.5_sibling_classical_h2) <- NULL
REM0.5_sibling_classical_h2
...
datMeta_agg0.5_twin_and_sibling_categorical <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_twin_and_sibling_categorical)
...
# Extract grand h2
REM0.5_twin_and_sibling_categorical_h2 <- fisherz2r(coef(REM0.5_twin_and_sibling_categorical))
names(REM0.5_twin_and_sibling_categorical_h2) <- NULL
REM0.5_twin_and_sibling_categorical_h2
...
datMeta_agg0.5_twin_and_sibling_classical <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_twin_and_sibling_classical)
...
# Extract grand h2
REM0.5_twin_and_sibling_classical_h2 <- fisherz2r(coef(REM0.5_twin_and_sibling_classical))
names(REM0.5_twin_and_sibling_classical_h2) <- NULL
REM0.5_twin_and_sibling_classical_h2
...
datMeta_agg0.5_twin_and_sibling_dfextremes <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_twin_and_sibling_dfextremes)
...
# Extract grand h2
REM0.5_twin_and_sibling_dfextremes_h2 <- fisherz2r(coef(REM0.5_twin_and_sibling_dfextremes))
names(REM0.5_twin_and_sibling_dfextremes_h2) <- NULL
REM0.5_twin_and_sibling_dfextremes_h2
...
datMeta_agg0.5_twin_categorical <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_twin_categorical)
...
# Extract grand h2
REM0.5_twin_categorical_h2 <- fisherz2r(coef(REM0.5_twin_categorical))
names(REM0.5_twin_categorical_h2) <- NULL
REM0.5_twin_categorical_h2
...
datMeta_agg0.5_twin_classical <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_twin_classical)
...
# Extract grand h2
REM0.5_twin_classical_h2 <- fisherz2r(coef(REM0.5_twin_classical))
names(REM0.5_twin_classical_h2) <- NULL
REM0.5_twin_classical_h2
...
datMeta_agg0.5_twin_dfextremes <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_twin_dfextremes)
...
# Extract grand h2
REM0.5_twin_dfextremes_h2 <- fisherz2r(coef(REM0.5_twin_dfextremes))
names(REM0.5_twin_dfextremes_h2) <- NULL
REM0.5_twin_dfextremes_h2
...
designs_h2 <- rbind(REM0.5_sibling_categorical_h2,
                    REM0.5_sibling_classical_h2,
                    REM0.5_twin_and_sibling_categorical_h2,
                    REM0.5_twin_and_sibling_dfextremes_h2,
                    REM0.5_twin_and_sibling_classical_h2,
...
designs <- cbind(designs_h2, designs_se, designs_k)
designs
...
datMeta_agg0.5_Aonly <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_Aonly)
...
# Extract grand h2
REM0.5_Aonly_h2 <- fisherz2r(coef(REM0.5_Aonly))
names(REM0.5_Aonly_h2) <- NULL
REM0.5_Aonly_h2
...
datMeta_agg0.5_BEST <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_BEST)
...
# Extract grand h2
REM0.5_BEST_h2 <- fisherz2r(coef(REM0.5_BEST))
names(REM0.5_BEST_h2) <- NULL
REM0.5_BEST_h2
...
datMeta_agg0.5_DFAonly <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_DFAonly)
...
# Extract grand h2
REM0.5_DFAonly_h2 <- fisherz2r(coef(REM0.5_DFAonly))
names(REM0.5_DFAonly_h2) <- NULL
REM0.5_DFAonly_h2
...
datMeta_agg0.5_DFBEST <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_DFBEST)
...
# Extract grand h2
REM0.5_DFBEST_h2 <- fisherz2r(coef(REM0.5_DFBEST))
names(REM0.5_DFBEST_h2) <- NULL
REM0.5_DFBEST_h2
...
datMeta_agg0.5_DFFULL <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_DFFULL)
...
# Extract grand h2
REM0.5_DFFULL_h2 <- fisherz2r(coef(REM0.5_DFFULL))
names(REM0.5_DFFULL_h2) <- NULL
REM0.5_DFFULL_h2
...
datMeta_agg0.5_FULL <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_FULL)
...
# Extract grand h2
REM0.5_FULL_h2 <- fisherz2r(coef(REM0.5_FULL))
names(REM0.5_FULL_h2) <- NULL
REM0.5_FULL_h2
...
datMeta_agg0.5_TC <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_TC)
...
# Extract grand h2
REM0.5_TC_h2 <- fisherz2r(coef(REM0.5_TC))
names(REM0.5_TC_h2) <- NULL
REM0.5_TC_h2
...
models_h2 <- rbind(REM0.5_Aonly_h2,
                   REM0.5_BEST_h2,
                   REM0.5_FULL_h2,
                   REM0.5_DFAonly_h2,
                   REM0.5_DFBEST_h2,
...
models <- cbind(models_h2, models_se, models_k)
models
...
datMeta_agg0.5_diagnosis <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_diagnosis)
...
# Extract grand h2
REM0.5_diagnosis_h2 <- fisherz2r(coef(REM0.5_diagnosis))
names(REM0.5_diagnosis_h2) <- NULL
REM0.5_diagnosis_h2
...
datMeta_agg0.5_parent <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_parent)
...
# Extract grand h2
REM0.5_parent_h2 <- fisherz2r(coef(REM0.5_parent))
names(REM0.5_parent_h2) <- NULL
REM0.5_parent_h2
...
datMeta_agg0.5_parent_self <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_parent_self)
...
# Extract grand h2
REM0.5_parent_self_h2 <- fisherz2r(coef(REM0.5_parent_self))
names(REM0.5_parent_self_h2) <- NULL
REM0.5_parent_self_h2
...
datMeta_agg0.5_parent_teacher <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_parent_teacher)
...
# Extract grand h2
REM0.5_parent_teacher_h2 <- fisherz2r(coef(REM0.5_parent_teacher))
names(REM0.5_parent_teacher_h2) <- NULL
REM0.5_parent_teacher_h2
...
datMeta_agg0.5_researcher <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_researcher)
...
# Extract grand h2
REM0.5_researcher_h2 <- fisherz2r(coef(REM0.5_researcher))
names(REM0.5_researcher_h2) <- NULL
REM0.5_researcher_h2
...
datMeta_agg0.5_self <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_self)
...
# Extract grand h2
REM0.5_self_h2 <- fisherz2r(coef(REM0.5_self))
names(REM0.5_self_h2) <- NULL
REM0.5_self_h2
...
datMeta_agg0.5_teacher <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_teacher)
...
# Extract grand h2
REM0.5_teacher_h2 <- fisherz2r(coef(REM0.5_teacher))
names(REM0.5_teacher_h2) <- NULL
REM0.5_teacher_h2
...
datMeta_agg0.5_test <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_test)
...
# Extract grand h2
REM0.5_test_h2 <- fisherz2r(coef(REM0.5_test))
names(REM0.5_test_h2) <- NULL
REM0.5_test_h2
...
raters_h2 <- rbind(REM0.5_diagnosis_h2,
                   REM0.5_parent_h2,
                   REM0.5_parent_self_h2,
                   REM0.5_parent_teacher_h2,
                   REM0.5_researcher_h2,
...
raters <- cbind(raters_h2, raters_se, raters_k)
...
datMeta_agg0.5_categorical <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_categorical)
...
# Extract grand h2
REM0.5_categorical_h2 <- fisherz2r(coef(REM0.5_categorical))
names(REM0.5_categorical_h2) <- NULL
REM0.5_categorical_h2
...
datMeta_agg0.5_continuous <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_continuous)
...
# Extract grand h2
REM0.5_continuous_h2 <- fisherz2r(coef(REM0.5_continuous))
names(REM0.5_continuous_h2) <- NULL
REM0.5_continuous_h2
...
scales_h2 <- rbind(REM0.5_categorical_h2,
                   REM0.5_continuous_h2)
...
scales <- cbind(scales_h2, scales_se, scales_k)
scales
...
datMeta_agg0.5_50 <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_50)
...
# Extract grand h2
REM0.5_50_h2 <- fisherz2r(coef(REM0.5_50))
names(REM0.5_50_h2) <- NULL
REM0.5_50_h2
...
datMeta_agg0.5_50_75 <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_50_75)
...
# Extract grand h2
REM0.5_50_75_h2 <- fisherz2r(coef(REM0.5_50_75))
names(REM0.5_50_75_h2) <- NULL
REM0.5_50_75_h2
...
datMeta_agg0.5_75_100 <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_75_100)
...
# Extract grand h2
REM0.5_75_100_h2 <- fisherz2r(coef(REM0.5_75_100))
names(REM0.5_75_100_h2) <- NULL
REM0.5_75_100_h2
...
datMeta_agg0.5_100 <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_100)
...
# Extract grand h2
REM0.5_100_h2 <- fisherz2r(coef(REM0.5_100))
names(REM0.5_100_h2) <- NULL
REM0.5_100_h2
...
ethnicities_h2 <- rbind(REM0.5_50_h2,
                        REM0.5_50_75_h2,
                        REM0.5_75_100_h2,
                        REM0.5_100_h2)
...
ethnicities <- cbind(ethnicities_h2, ethnicities_se, ethnicities_k)
ethnicities
...
datMeta_agg0.5_0 <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_0)
...
# Extract grand h2
REM0.5_0_h2 <- fisherz2r(coef(REM0.5_0))
names(REM0.5_0_h2) <- NULL
REM0.5_0_h2
...
datMeta_agg0.5_1 <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_1)
...
# Extract grand h2
REM0.5_1_h2 <- fisherz2r(coef(REM0.5_1))
names(REM0.5_1_h2) <- NULL
REM0.5_1_h2
...
datMeta_agg0.5_2 <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_2)
...
# Extract grand h2
REM0.5_2_h2 <- fisherz2r(coef(REM0.5_2))
names(REM0.5_2_h2) <- NULL
REM0.5_2_h2
...
datMeta_agg0.5_3 <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_3)
...
# Extract grand h2
REM0.5_3_h2 <- fisherz2r(coef(REM0.5_3))
names(REM0.5_3_h2) <- NULL
REM0.5_3_h2
...
datMeta_agg0.5_4 <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_4)
...
# Extract grand h2
REM0.5_4_h2 <- fisherz2r(coef(REM0.5_4))
names(REM0.5_4_h2) <- NULL
REM0.5_4_h2
...
nocovs <- cbind(nocovs_h2, nocovs_se, nocovs_k)
nocovs
...
datMeta_agg0.5_Australia <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_Australia)
...
# Extract grand h2
REM0.5_Australia_h2 <- fisherz2r(coef(REM0.5_Australia))
names(REM0.5_Australia_h2) <- NULL
REM0.5_Australia_h2
...
datMeta_agg0.5_Aus_USA_Nor_Swe <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_Aus_USA_Nor_Swe)
...
# Extract grand h2
REM0.5_Aus_USA_Nor_Swe_h2 <- fisherz2r(coef(REM0.5_Aus_USA_Nor_Swe))
names(REM0.5_Aus_USA_Nor_Swe_h2) <- NULL
REM0.5_Aus_USA_Nor_Swe_h2
...
datMeta_agg0.5_Canada <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_Canada)
...
# Extract grand h2
REM0.5_Canada_h2 <- fisherz2r(coef(REM0.5_Canada))
names(REM0.5_Canada_h2) <- NULL
REM0.5_Canada_h2
...
datMeta_agg0.5_China <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_China)
...
# Extract grand h2
REM0.5_China_h2 <- fisherz2r(coef(REM0.5_China))
names(REM0.5_China_h2) <- NULL
REM0.5_China_h2
...
datMeta_agg0.5_Netherlands <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_Netherlands)
...
# Extract grand h2
REM0.5_Netherlands_h2 <- fisherz2r(coef(REM0.5_Netherlands))
names(REM0.5_Netherlands_h2) <- NULL
REM0.5_Netherlands_h2
...
datMeta_agg0.5_Norway <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_Norway)
...
# Extract grand h2
REM0.5_Norway_h2 <- fisherz2r(coef(REM0.5_Norway))
names(REM0.5_Norway_h2) <- NULL
REM0.5_Norway_h2
...
datMeta_agg0.5_Sweden <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_Sweden)
...
# Extract grand h2
REM0.5_Sweden_h2 <- fisherz2r(coef(REM0.5_Sweden))
names(REM0.5_Sweden_h2) <- NULL
REM0.5_Sweden_h2
...
datMeta_agg0.5_UK <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_UK)
...
# Extract grand h2
REM0.5_UK_h2 <- fisherz2r(coef(REM0.5_UK))
names(REM0.5_UK_h2) <- NULL
REM0.5_UK_h2
...
datMeta_agg0.5_USA <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_USA)
...
# Extract grand h2
REM0.5_USA_h2 <- fisherz2r(coef(REM0.5_USA))
names(REM0.5_USA_h2) <- NULL
REM0.5_USA_h2
...
countries_h2 <- rbind(REM0.5_Australia_h2,
                      REM0.5_Aus_USA_Nor_Swe_h2,
                      REM0.5_Canada_h2,
                      REM0.5_China_h2,
                      REM0.5_Netherlands_h2,
...
countries <- cbind(countries_h2, countries_se, countries_k)
countries
...
datMeta_agg0.5_ADHD <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_ADHD)
...
# Extract grand h2
REM0.5_ADHD_h2 <- fisherz2r(coef(REM0.5_ADHD))
names(REM0.5_ADHD_h2) <- NULL
REM0.5_ADHD_h2
...
datMeta_agg0.5_ASD <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_ASD)
...
# Extract grand h2
REM0.5_ASD_h2 <- fisherz2r(coef(REM0.5_ASD))
names(REM0.5_ASD_h2) <- NULL
REM0.5_ASD_h2
...
datMeta_agg0.5_CMD <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_CMD)
...
# Extract grand h2
REM0.5_CMD_h2 <- fisherz2r(coef(REM0.5_CMD))
names(REM0.5_CMD_h2) <- NULL
REM0.5_CMD_h2
...
datMeta_agg0.5_SLD <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_SLD)
...
# Extract grand h2
REM0.5_SLD_h2 <- fisherz2r(coef(REM0.5_SLD))
names(REM0.5_SLD_h2) <- NULL
REM0.5_SLD_h2
...
datMeta_agg0.5_LD <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_LD)
...
# Extract grand h2
REM0.5_LD_h2 <- fisherz2r(coef(REM0.5_LD))
names(REM0.5_LD_h2) <- NULL
REM0.5_LD_h2
...
datMeta_agg0.5_MD <- agg(id=Full.Ref, es=FZ_h2, var=h2_SE, cor=0.5, data=datMeta_MD)
...
# Extract grand h2
REM0.5_MD_h2 <- fisherz2r(coef(REM0.5_MD))
names(REM0.5_MD_h2) <- NULL
REM0.5_MD_h2
...
disorders_h2 <- rbind(REM0.5_SLD_h2,
                      REM0.5_ADHD_h2,
                      REM0.5_ASD_h2,
                      REM0.5_CMD_h2,
                      REM0.5_MD_h2,
...
disorders <- cbind(disorders_h2, disorders_se, disorders_k)
disorders
