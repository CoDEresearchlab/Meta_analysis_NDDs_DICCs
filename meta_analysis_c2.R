...
REM0.5_childhood_c2 <- NA                   
REM0.5_middlechildhood_c2 <- NA             
REM0.5_adolescence_c2 <- NA                 
REM0.5_childhood_middlechildhood_c2 <- NA   
REM0.5_childhood_adolescence_c2 <- NA       
REM0.5_middlechildhood_adolescence_c2 <- NA 
REM0.5_sibling_categorical_c2 <- NA         
REM0.5_sibling_classical_c2 <- NA           
REM0.5_twin_and_sibling_categorical_c2 <- NA
REM0.5_twin_and_sibling_dfextremes_c2 <- NA 
REM0.5_twin_and_sibling_classical_c2 <- NA  
REM0.5_twin_categorical_c2 <- NA            
REM0.5_twin_dfextremes_c2 <- NA             
REM0.5_twin_classical_c2 <- NA              
REM0.5_Aonly_c2 <- NA                       
REM0.5_BEST_c2 <- NA                        
REM0.5_FULL_c2 <- NA                        
REM0.5_DFAonly_c2 <- NA                     
REM0.5_DFBEST_c2 <- NA                      
REM0.5_DFFULL_c2 <- NA                      
REM0.5_TC_c2 <- NA                          
REM0.5_diagnosis_c2 <- NA                   
REM0.5_parent_c2 <- NA                      
REM0.5_parent_self_c2 <- NA                 
REM0.5_parent_teacher_c2 <- NA              
REM0.5_researcher_c2 <- NA                  
REM0.5_self_c2 <- NA                        
REM0.5_teacher_c2 <- NA                     
REM0.5_test_c2 <- NA                        
REM0.5_categorical_c2 <- NA                 
REM0.5_continuous_c2 <- NA                  
REM0.5_50_c2 <- NA                          
REM0.5_50_75_c2 <- NA                       
REM0.5_75_100_c2 <- NA                      
REM0.5_100_c2 <- NA                         
...
REM0.5_3_c2 <- NA                           
REM0.5_4_c2 <- NA                           
REM0.5_Australia_c2 <- NA                   
REM0.5_Aus_USA_Nor_Swe_c2 <- NA             
REM0.5_Canada_c2 <- NA                      
REM0.5_China_c2 <- NA                       
REM0.5_Netherlands_c2 <- NA                 
REM0.5_Norway_c2 <- NA                      
REM0.5_Sweden_c2 <- NA                      
REM0.5_UK_c2 <- NA                          
REM0.5_USA_c2 <- NA    
...
datMeta_agg0.3 <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.3, data=datMeta)
datMeta_agg0.9 <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.9, data=datMeta)
...
REM0.3_nocov_c2 <- fisherz2r(coef(REM0.3_nocov))
names(REM0.3_nocov_c2) <- NULL
REM0.3_nocov_c2

REM0.9_nocov_c2 <- fisherz2r(coef(REM0.9_nocov))
names(REM0.9_nocov_c2) <- NULL
REM0.9_nocov_c2

cbind(REM0.5_nocov_c2, REM0.3_nocov_c2, REM0.9_nocov_c2) #No difference :)
...
datMeta_agg0.5_cohort <- agg(id=Cohort, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta)
datMeta_agg0.3_cohort <- agg(id=Cohort, es=FZ_c2, var=c2_SE, cor=0.3, data=datMeta)
datMeta_agg0.9_cohort <- agg(id=Cohort, es=FZ_c2, var=c2_SE, cor=0.9, data=datMeta)
...
# Extract grand c2
REM0.5_cohort_nocov_c2 <- fisherz2r(coef(REM0.5_cohort_nocov))
names(REM0.5_cohort_nocov_c2) <- NULL
REM0.5_cohort_nocov_c2

REM0.3_cohort_nocov_c2 <- fisherz2r(coef(REM0.3_cohort_nocov))
names(REM0.3_cohort_nocov_c2) <- NULL
REM0.3_cohort_nocov_c2

REM0.9_cohort_nocov_c2 <- fisherz2r(coef(REM0.9_cohort_nocov))
names(REM0.9_cohort_nocov_c2) <- NULL
REM0.9_cohort_nocov_c2

cbind(REM0.5_cohort_nocov_c2, REM0.3_cohort_nocov_c2, REM0.9_cohort_nocov_c2) #No difference :)
...
datMeta_agg0.5_country <- agg(id=Cohort_country1, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta)
datMeta_agg0.3_country <- agg(id=Cohort_country1, es=FZ_c2, var=c2_SE, cor=0.3, data=datMeta)
datMeta_agg0.9_country <- agg(id=Cohort_country1, es=FZ_c2, var=c2_SE, cor=0.9, data=datMeta)
...
# Extract grand c2
REM0.5_country_nocov_c2 <- fisherz2r(coef(REM0.5_country_nocov))
names(REM0.5_country_nocov_c2) <- NULL
REM0.5_country_nocov_c2

REM0.3_country_nocov_c2 <- fisherz2r(coef(REM0.3_country_nocov))
names(REM0.3_country_nocov_c2) <- NULL
REM0.3_country_nocov_c2

REM0.9_country_nocov_c2 <- fisherz2r(coef(REM0.9_country_nocov))
names(REM0.9_country_nocov_c2) <- NULL
REM0.9_country_nocov_c2

cbind(REM0.5_country_nocov_c2, REM0.3_country_nocov_c2, REM0.9_country_nocov_c2) #No difference :)
...
datMeta_agg0.5_childhood <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_childhood)
...
# Extract grand c2
REM0.5_childhood_c2 <- fisherz2r(coef(REM0.5_childhood))
names(REM0.5_childhood_c2) <- NULL
REM0.5_childhood_c2
...
datMeta_agg0.5_middlechildhood <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_middlechildhood)
...
# Extract grand c2
REM0.5_middlechildhood_c2 <- fisherz2r(coef(REM0.5_middlechildhood))
names(REM0.5_middlechildhood_c2) <- NULL
REM0.5_middlechildhood_c2
...
datMeta_agg0.5_adolescence <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_adolescence)
...
# Extract grand c2
REM0.5_adolescence_c2 <- fisherz2r(coef(REM0.5_adolescence))
names(REM0.5_adolescence_c2) <- NULL
REM0.5_adolescence_c2
...
datMeta_agg0.5_childhood_middlechildhood <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_childhood_middlechildhood)
...
# Extract grand c2
REM0.5_childhood_middlechildhood_c2 <- fisherz2r(coef(REM0.5_childhood_middlechildhood))
names(REM0.5_childhood_middlechildhood_c2) <- NULL
REM0.5_childhood_middlechildhood_c2
...
datMeta_agg0.5_middlechildhood_adolescence <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_middlechildhood_adolescence)
...
# Extract grand c2
REM0.5_middlechildhood_adolescence_c2 <- fisherz2r(coef(REM0.5_middlechildhood_adolescence))
names(REM0.5_middlechildhood_adolescence_c2) <- NULL
REM0.5_middlechildhood_adolescence_c2
...
datMeta_agg0.5_childhood_adolescence <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_childhood_adolescence)
...
# Extract grand c2
REM0.5_childhood_adolescence_c2 <- fisherz2r(coef(REM0.5_childhood_adolescence))
names(REM0.5_childhood_adolescence_c2) <- NULL
REM0.5_childhood_adolescence_c2
...
ages_c2 <- rbind(REM0.5_childhood_c2,
                 REM0.5_middlechildhood_c2,
                 REM0.5_adolescence_c2,
                 REM0.5_childhood_middlechildhood_c2,
                 REM0.5_childhood_adolescence_c2,
...
ages <- cbind(ages_c2, ages_se, ages_k)
...
datMeta_agg0.5_sibling_categorical <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_sibling_categorical)
...
# Extract grand c2
REM0.5_sibling_categorical_c2 <- fisherz2r(coef(REM0.5_sibling_categorical))
names(REM0.5_sibling_categorical_c2) <- NULL
REM0.5_sibling_categorical_c2
...
datMeta_agg0.5_sibling_classical <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_sibling_classical)
...
# Extract grand c2
REM0.5_sibling_classical_c2 <- fisherz2r(coef(REM0.5_sibling_classical))
names(REM0.5_sibling_classical_c2) <- NULL
REM0.5_sibling_classical_c2
...
datMeta_agg0.5_twin_and_sibling_categorical <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_twin_and_sibling_categorical)
...
# Extract grand c2
REM0.5_twin_and_sibling_categorical_c2 <- fisherz2r(coef(REM0.5_twin_and_sibling_categorical))
names(REM0.5_twin_and_sibling_categorical_c2) <- NULL
REM0.5_twin_and_sibling_categorical_c2
...
datMeta_agg0.5_twin_and_sibling_classical <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_twin_and_sibling_classical)
...
# Extract grand c2
REM0.5_twin_and_sibling_classical_c2 <- fisherz2r(coef(REM0.5_twin_and_sibling_classical))
names(REM0.5_twin_and_sibling_classical_c2) <- NULL
REM0.5_twin_and_sibling_classical_c2
...
datMeta_agg0.5_twin_and_sibling_dfextremes <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_twin_and_sibling_dfextremes)
...
# Extract grand c2
REM0.5_twin_and_sibling_dfextremes_c2 <- fisherz2r(coef(REM0.5_twin_and_sibling_dfextremes))
names(REM0.5_twin_and_sibling_dfextremes_c2) <- NULL
REM0.5_twin_and_sibling_dfextremes_c2
...
datMeta_agg0.5_twin_categorical <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_twin_categorical)
...
# Extract grand c2
REM0.5_twin_categorical_c2 <- fisherz2r(coef(REM0.5_twin_categorical))
names(REM0.5_twin_categorical_c2) <- NULL
REM0.5_twin_categorical_c2
...
datMeta_agg0.5_twin_classical <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_twin_classical)
...
# Extract grand c2
REM0.5_twin_classical_c2 <- fisherz2r(coef(REM0.5_twin_classical))
names(REM0.5_twin_classical_c2) <- NULL
REM0.5_twin_classical_c2
...
datMeta_agg0.5_twin_dfextremes <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_twin_dfextremes)
...
# Extract grand c2
REM0.5_twin_dfextremes_c2 <- fisherz2r(coef(REM0.5_twin_dfextremes))
names(REM0.5_twin_dfextremes_c2) <- NULL
REM0.5_twin_dfextremes_c2
...
designs_c2 <- rbind(REM0.5_sibling_categorical_c2,
                    REM0.5_sibling_classical_c2,
                    REM0.5_twin_and_sibling_categorical_c2,
                    REM0.5_twin_and_sibling_dfextremes_c2,
                    REM0.5_twin_and_sibling_classical_c2,
...
designs <- cbind(designs_c2, designs_se, designs_k)
designs
...
datMeta_agg0.5_Aonly <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_Aonly)
...
# Extract grand c2
REM0.5_Aonly_c2 <- fisherz2r(coef(REM0.5_Aonly))
names(REM0.5_Aonly_c2) <- NULL
REM0.5_Aonly_c2
...
datMeta_agg0.5_BEST <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_BEST)
...
# Extract grand c2
REM0.5_BEST_c2 <- fisherz2r(coef(REM0.5_BEST))
names(REM0.5_BEST_c2) <- NULL
REM0.5_BEST_c2
...
datMeta_agg0.5_DFAonly <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_DFAonly)
...
# Extract grand c2
REM0.5_DFAonly_c2 <- fisherz2r(coef(REM0.5_DFAonly))
names(REM0.5_DFAonly_c2) <- NULL
REM0.5_DFAonly_c2
...
datMeta_agg0.5_DFBEST <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_DFBEST)
...
# Extract grand c2
REM0.5_DFBEST_c2 <- fisherz2r(coef(REM0.5_DFBEST))
names(REM0.5_DFBEST_c2) <- NULL
REM0.5_DFBEST_c2
...
datMeta_agg0.5_DFFULL <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_DFFULL)
...
# Extract grand c2
REM0.5_DFFULL_c2 <- fisherz2r(coef(REM0.5_DFFULL))
names(REM0.5_DFFULL_c2) <- NULL
REM0.5_DFFULL_c2
...
datMeta_agg0.5_FULL <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_FULL)
...
# Extract grand c2
REM0.5_FULL_c2 <- fisherz2r(coef(REM0.5_FULL))
names(REM0.5_FULL_c2) <- NULL
REM0.5_FULL_c2
...
datMeta_agg0.5_TC <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_TC)
...
# Extract grand c2
REM0.5_TC_c2 <- fisherz2r(coef(REM0.5_TC))
names(REM0.5_TC_c2) <- NULL
REM0.5_TC_c2
...
models_c2 <- rbind(REM0.5_Aonly_c2,
                   REM0.5_BEST_c2,
                   REM0.5_FULL_c2,
                   REM0.5_DFAonly_c2,
                   REM0.5_DFBEST_c2,
...
models <- cbind(models_c2, models_se, models_k)
models
...
datMeta_agg0.5_diagnosis <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_diagnosis)
...
# Extract grand c2
REM0.5_diagnosis_c2 <- fisherz2r(coef(REM0.5_diagnosis))
names(REM0.5_diagnosis_c2) <- NULL
REM0.5_diagnosis_c2
...
datMeta_agg0.5_parent <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_parent)
...
# Extract grand c2
REM0.5_parent_c2 <- fisherz2r(coef(REM0.5_parent))
names(REM0.5_parent_c2) <- NULL
REM0.5_parent_c2
...
datMeta_agg0.5_parent_self <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_parent_self)
...
# Extract grand c2
REM0.5_parent_self_c2 <- fisherz2r(coef(REM0.5_parent_self))
names(REM0.5_parent_self_c2) <- NULL
REM0.5_parent_self_c2
...
datMeta_agg0.5_parent_teacher <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_parent_teacher)
...
# Extract grand c2
REM0.5_parent_teacher_c2 <- fisherz2r(coef(REM0.5_parent_teacher))
names(REM0.5_parent_teacher_c2) <- NULL
REM0.5_parent_teacher_c2
...
datMeta_agg0.5_researcher <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_researcher)
...
# Extract grand c2
REM0.5_researcher_c2 <- fisherz2r(coef(REM0.5_researcher))
names(REM0.5_researcher_c2) <- NULL
REM0.5_researcher_c2
...
datMeta_agg0.5_self <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_self)
...
# Extract grand c2
REM0.5_self_c2 <- fisherz2r(coef(REM0.5_self))
names(REM0.5_self_c2) <- NULL
REM0.5_self_c2
...
datMeta_agg0.5_teacher <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_teacher)
...
# Extract grand c2
REM0.5_teacher_c2 <- fisherz2r(coef(REM0.5_teacher))
names(REM0.5_teacher_c2) <- NULL
REM0.5_teacher_c2
...
datMeta_agg0.5_test <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_test)
...
# Extract grand c2
REM0.5_test_c2 <- fisherz2r(coef(REM0.5_test))
names(REM0.5_test_c2) <- NULL
REM0.5_test_c2
...
raters_c2 <- rbind(REM0.5_diagnosis_c2,
                   REM0.5_parent_c2,
                   REM0.5_parent_self_c2,
                   REM0.5_parent_teacher_c2,
                   REM0.5_researcher_c2,
...
raters <- cbind(raters_c2, raters_se, raters_k)
...
datMeta_agg0.5_categorical <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_categorical)
...
# Extract grand c2
REM0.5_categorical_c2 <- fisherz2r(coef(REM0.5_categorical))
names(REM0.5_categorical_c2) <- NULL
REM0.5_categorical_c2
...
datMeta_agg0.5_continuous <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_continuous)
...
# Extract grand c2
REM0.5_continuous_c2 <- fisherz2r(coef(REM0.5_continuous))
names(REM0.5_continuous_c2) <- NULL
REM0.5_continuous_c2
...
scales_c2 <- rbind(REM0.5_categorical_c2,
                   REM0.5_continuous_c2)
...
scales <- cbind(scales_c2, scales_se, scales_k)
scales
...
datMeta_agg0.5_50 <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_50)
...
# Extract grand c2
REM0.5_50_c2 <- fisherz2r(coef(REM0.5_50))
names(REM0.5_50_c2) <- NULL
REM0.5_50_c2
...
datMeta_agg0.5_50_75 <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_50_75)
...
# Extract grand c2
REM0.5_50_75_c2 <- fisherz2r(coef(REM0.5_50_75))
names(REM0.5_50_75_c2) <- NULL
REM0.5_50_75_c2
...
datMeta_agg0.5_75_100 <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_75_100)
...
# Extract grand c2
REM0.5_75_100_c2 <- fisherz2r(coef(REM0.5_75_100))
names(REM0.5_75_100_c2) <- NULL
REM0.5_75_100_c2
...
datMeta_agg0.5_100 <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_100)
...
# Extract grand c2
REM0.5_100_c2 <- fisherz2r(coef(REM0.5_100))
names(REM0.5_100_c2) <- NULL
REM0.5_100_c2
...
ethnicities_c2 <- rbind(REM0.5_50_c2,
                        REM0.5_50_75_c2,
                        REM0.5_75_100_c2,
                        REM0.5_100_c2)
...
ethnicities <- cbind(ethnicities_c2, ethnicities_se, ethnicities_k)
ethnicities
...
datMeta_agg0.5_0 <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_0)
...
# Extract grand c2
REM0.5_0_c2 <- fisherz2r(coef(REM0.5_0))
names(REM0.5_0_c2) <- NULL
REM0.5_0_c2
...
datMeta_agg0.5_1 <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_1)
...
# Extract grand c2
REM0.5_1_c2 <- fisherz2r(coef(REM0.5_1))
names(REM0.5_1_c2) <- NULL
REM0.5_1_c2
...
datMeta_agg0.5_2 <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_2)
...
# Extract grand c2
REM0.5_2_c2 <- fisherz2r(coef(REM0.5_2))
names(REM0.5_2_c2) <- NULL
REM0.5_2_c2
...
datMeta_agg0.5_3 <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_3)
...
# Extract grand c2
REM0.5_3_c2 <- fisherz2r(coef(REM0.5_3))
names(REM0.5_3_c2) <- NULL
REM0.5_3_c2
...
datMeta_agg0.5_4 <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_4)
...
# Extract grand c2
REM0.5_4_c2 <- fisherz2r(coef(REM0.5_4))
names(REM0.5_4_c2) <- NULL
REM0.5_4_c2
...
nocovs <- cbind(nocovs_c2, nocovs_se, nocovs_k)
nocovs
...
datMeta_agg0.5_Australia <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_Australia)
...
# Extract grand c2
REM0.5_Australia_c2 <- fisherz2r(coef(REM0.5_Australia))
names(REM0.5_Australia_c2) <- NULL
REM0.5_Australia_c2
...
datMeta_agg0.5_Aus_USA_Nor_Swe <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_Aus_USA_Nor_Swe)
...
# Extract grand c2
REM0.5_Aus_USA_Nor_Swe_c2 <- fisherz2r(coef(REM0.5_Aus_USA_Nor_Swe))
names(REM0.5_Aus_USA_Nor_Swe_c2) <- NULL
REM0.5_Aus_USA_Nor_Swe_c2
...
datMeta_agg0.5_Canada <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_Canada)
...
# Extract grand c2
REM0.5_Canada_c2 <- fisherz2r(coef(REM0.5_Canada))
names(REM0.5_Canada_c2) <- NULL
REM0.5_Canada_c2
...
datMeta_agg0.5_China <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_China)
...
# Extract grand c2
REM0.5_China_c2 <- fisherz2r(coef(REM0.5_China))
names(REM0.5_China_c2) <- NULL
REM0.5_China_c2
...
datMeta_agg0.5_Netherlands <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_Netherlands)
...
# Extract grand c2
REM0.5_Netherlands_c2 <- fisherz2r(coef(REM0.5_Netherlands))
names(REM0.5_Netherlands_c2) <- NULL
REM0.5_Netherlands_c2
...
datMeta_agg0.5_Norway <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_Norway)
...
# Extract grand c2
REM0.5_Norway_c2 <- fisherz2r(coef(REM0.5_Norway))
names(REM0.5_Norway_c2) <- NULL
REM0.5_Norway_c2
...
datMeta_agg0.5_Sweden <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_Sweden)
...
# Extract grand c2
REM0.5_Sweden_c2 <- fisherz2r(coef(REM0.5_Sweden))
names(REM0.5_Sweden_c2) <- NULL
REM0.5_Sweden_c2
...
datMeta_agg0.5_UK <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_UK)
...
# Extract grand c2
REM0.5_UK_c2 <- fisherz2r(coef(REM0.5_UK))
names(REM0.5_UK_c2) <- NULL
REM0.5_UK_c2
...
datMeta_agg0.5_USA <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_USA)
...
# Extract grand c2
REM0.5_USA_c2 <- fisherz2r(coef(REM0.5_USA))
names(REM0.5_USA_c2) <- NULL
REM0.5_USA_c2
...
countries_c2 <- rbind(REM0.5_Australia_c2,
                      REM0.5_Aus_USA_Nor_Swe_c2,
                      REM0.5_Canada_c2,
                      REM0.5_China_c2,
                      REM0.5_Netherlands_c2,
...
countries <- cbind(countries_c2, countries_se, countries_k)
countries
...
datMeta_agg0.5_ADHD <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_ADHD)
...
# Extract grand c2
REM0.5_ADHD_c2 <- fisherz2r(coef(REM0.5_ADHD))
names(REM0.5_ADHD_c2) <- NULL
REM0.5_ADHD_c2
...
datMeta_agg0.5_ASD <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_ASD)
...
# Extract grand c2
REM0.5_ASD_c2 <- fisherz2r(coef(REM0.5_ASD))
names(REM0.5_ASD_c2) <- NULL
REM0.5_ASD_c2
...
datMeta_agg0.5_CMD <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_CMD)
...
# Extract grand c2
REM0.5_CMD_c2 <- fisherz2r(coef(REM0.5_CMD))
names(REM0.5_CMD_c2) <- NULL
REM0.5_CMD_c2
...
datMeta_agg0.5_SLD <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_SLD)
...
# Extract grand c2
REM0.5_SLD_c2 <- fisherz2r(coef(REM0.5_SLD))
names(REM0.5_SLD_c2) <- NULL
REM0.5_SLD_c2
...
datMeta_agg0.5_LD <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_LD)
...
# Extract grand c2
REM0.5_LD_c2 <- fisherz2r(coef(REM0.5_LD))
names(REM0.5_LD_c2) <- NULL
REM0.5_LD_c2
...
datMeta_agg0.5_MD <- agg(id=Full.Ref, es=FZ_c2, var=c2_SE, cor=0.5, data=datMeta_MD)
...
# Extract grand c2
REM0.5_MD_c2 <- fisherz2r(coef(REM0.5_MD))
names(REM0.5_MD_c2) <- NULL
REM0.5_MD_c2
...
disorders_c2 <- rbind(REM0.5_SLD_c2,
                      REM0.5_ADHD_c2,
                      REM0.5_ASD_c2,
                      REM0.5_CMD_c2,
                      REM0.5_MD_c2,
...
disorders <- cbind(disorders_c2, disorders_se, disorders_k)
disorders
