...
REM0.5_childhood_rC <- NA                   
REM0.5_middlechildhood_rC <- NA             
REM0.5_adolescence_rC <- NA                 
REM0.5_childhood_middlechildhood_rC <- NA   
REM0.5_childhood_adolescence_rC <- NA       
REM0.5_middlechildhood_adolescence_rC <- NA 
REM0.5_sibling_categorical_rC <- NA         
REM0.5_sibling_classical_rC <- NA           
REM0.5_twin_and_sibling_categorical_rC <- NA
REM0.5_twin_and_sibling_dfextremes_rC <- NA 
REM0.5_twin_and_sibling_classical_rC <- NA  
REM0.5_twin_categorical_rC <- NA            
REM0.5_twin_dfextremes_rC <- NA             
REM0.5_twin_classical_rC <- NA              
REM0.5_Aonly_rC <- NA                       
REM0.5_BEST_rC <- NA                        
REM0.5_FULL_rC <- NA                        
REM0.5_DFAonly_rC <- NA                     
REM0.5_DFBEST_rC <- NA                      
REM0.5_DFFULL_rC <- NA                      
REM0.5_TC_rC <- NA                          
REM0.5_diagnosis_rC <- NA                   
REM0.5_parent_rC <- NA                      
REM0.5_parent_self_rC <- NA                 
REM0.5_parent_teacher_rC <- NA              
REM0.5_researcher_rC <- NA                  
REM0.5_self_rC <- NA                        
REM0.5_teacher_rC <- NA                     
REM0.5_test_rC <- NA                        
REM0.5_categorical_rC <- NA                 
REM0.5_continuous_rC <- NA                  
REM0.5_50_rC <- NA                          
REM0.5_50_75_rC <- NA                       
REM0.5_75_100_rC <- NA                      
REM0.5_100_rC <- NA                         
...
REM0.5_3_rC <- NA                           
REM0.5_4_rC <- NA                           
REM0.5_Australia_rC <- NA                   
REM0.5_Aus_USA_Nor_Swe_rC <- NA             
REM0.5_Canada_rC <- NA                      
REM0.5_China_rC <- NA                       
REM0.5_Netherlands_rC <- NA                 
REM0.5_Norway_rC <- NA                      
REM0.5_Sweden_rC <- NA                      
REM0.5_UK_rC <- NA                          
REM0.5_USA_rC <- NA    
...
# ============= Compute effect size and variance -- Converting rC into Fisher's Z ==========================
# ============= Treat rC as correlation and convert to Fisher's Z (SE will be used as variance) =============
...
datMeta_agg0.5 <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta)
datMeta_agg0.3 <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.3, data=datMeta)
datMeta_agg0.9 <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.9, data=datMeta)
...
# Extract grand rC
REM0.5_nocov_rC <- fisherz2r(coef(REM0.5_nocov))
names(REM0.5_nocov_rC) <- NULL
REM0.5_nocov_rC

REM0.3_nocov_rC <- fisherz2r(coef(REM0.3_nocov))
names(REM0.3_nocov_rC) <- NULL
REM0.3_nocov_rC

REM0.9_nocov_rC <- fisherz2r(coef(REM0.9_nocov))
names(REM0.9_nocov_rC) <- NULL
REM0.9_nocov_rC

cbind(REM0.5_nocov_rC, REM0.3_nocov_rC, REM0.9_nocov_rC) #No difference :)
...
datMeta_agg0.5_cohort <- agg(id=Cohort, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta)
datMeta_agg0.3_cohort <- agg(id=Cohort, es=FZ_rC, var=rC_SE, cor=0.3, data=datMeta)
datMeta_agg0.9_cohort <- agg(id=Cohort, es=FZ_rC, var=rC_SE, cor=0.9, data=datMeta)
...
# Extract grand rC
REM0.5_cohort_nocov_rC <- fisherz2r(coef(REM0.5_cohort_nocov))
names(REM0.5_cohort_nocov_rC) <- NULL
REM0.5_cohort_nocov_rC

REM0.3_cohort_nocov_rC <- fisherz2r(coef(REM0.3_cohort_nocov))
names(REM0.3_cohort_nocov_rC) <- NULL
REM0.3_cohort_nocov_rC

REM0.9_cohort_nocov_rC <- fisherz2r(coef(REM0.9_cohort_nocov))
names(REM0.9_cohort_nocov_rC) <- NULL
REM0.9_cohort_nocov_rC

cbind(REM0.5_cohort_nocov_rC, REM0.3_cohort_nocov_rC, REM0.9_cohort_nocov_rC) #No difference :)
...
datMeta_agg0.5_country <- agg(id=Cohort_country1, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta)
datMeta_agg0.3_country <- agg(id=Cohort_country1, es=FZ_rC, var=rC_SE, cor=0.3, data=datMeta)
datMeta_agg0.9_country <- agg(id=Cohort_country1, es=FZ_rC, var=rC_SE, cor=0.9, data=datMeta)
...
# Extract grand rC
REM0.5_country_nocov_rC <- fisherz2r(coef(REM0.5_country_nocov))
names(REM0.5_country_nocov_rC) <- NULL
REM0.5_country_nocov_rC

REM0.3_country_nocov_rC <- fisherz2r(coef(REM0.3_country_nocov))
names(REM0.3_country_nocov_rC) <- NULL
REM0.3_country_nocov_rC

REM0.9_country_nocov_rC <- fisherz2r(coef(REM0.9_country_nocov))
names(REM0.9_country_nocov_rC) <- NULL
REM0.9_country_nocov_rC

cbind(REM0.5_country_nocov_rC, REM0.3_country_nocov_rC, REM0.9_country_nocov_rC) #No difference :)
...
datMeta_agg0.5_childhood <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_childhood)
...
# Extract grand rC
REM0.5_childhood_rC <- fisherz2r(coef(REM0.5_childhood))
names(REM0.5_childhood_rC) <- NULL
REM0.5_childhood_rC
...
datMeta_agg0.5_middlechildhood <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_middlechildhood)
...
# Extract grand rC
REM0.5_middlechildhood_rC <- fisherz2r(coef(REM0.5_middlechildhood))
names(REM0.5_middlechildhood_rC) <- NULL
REM0.5_middlechildhood_rC
...
datMeta_agg0.5_adolescence <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_adolescence)
...
# Extract grand rC
REM0.5_adolescence_rC <- fisherz2r(coef(REM0.5_adolescence))
names(REM0.5_adolescence_rC) <- NULL
REM0.5_adolescence_rC
...
datMeta_agg0.5_childhood_middlechildhood <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_childhood_middlechildhood)
...
# Extract grand rC
REM0.5_childhood_middlechildhood_rC <- fisherz2r(coef(REM0.5_childhood_middlechildhood))
names(REM0.5_childhood_middlechildhood_rC) <- NULL
REM0.5_childhood_middlechildhood_rC
...
datMeta_agg0.5_middlechildhood_adolescence <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_middlechildhood_adolescence)
...
# Extract grand rC
REM0.5_middlechildhood_adolescence_rC <- fisherz2r(coef(REM0.5_middlechildhood_adolescence))
names(REM0.5_middlechildhood_adolescence_rC) <- NULL
REM0.5_middlechildhood_adolescence_rC
...
datMeta_agg0.5_childhood_adolescence <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_childhood_adolescence)
...
# Extract grand rC
REM0.5_childhood_adolescence_rC <- fisherz2r(coef(REM0.5_childhood_adolescence))
names(REM0.5_childhood_adolescence_rC) <- NULL
REM0.5_childhood_adolescence_rC
...
ages_rC <- rbind(REM0.5_childhood_rC,
                 REM0.5_middlechildhood_rC,
                 REM0.5_adolescence_rC,
                 REM0.5_childhood_middlechildhood_rC,
                 REM0.5_childhood_adolescence_rC,
...
ages <- cbind(ages_rC, ages_se, ages_k)
...
datMeta_agg0.5_sibling_categorical <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_sibling_categorical)
...
# Extract grand rC
REM0.5_sibling_categorical_rC <- fisherz2r(coef(REM0.5_sibling_categorical))
names(REM0.5_sibling_categorical_rC) <- NULL
REM0.5_sibling_categorical_rC
...
datMeta_agg0.5_sibling_classical <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_sibling_classical)
...
# Extract grand rC
REM0.5_sibling_classical_rC <- fisherz2r(coef(REM0.5_sibling_classical))
names(REM0.5_sibling_classical_rC) <- NULL
REM0.5_sibling_classical_rC
...
datMeta_agg0.5_twin_and_sibling_categorical <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_twin_and_sibling_categorical)
...
# Extract grand rC
REM0.5_twin_and_sibling_categorical_rC <- fisherz2r(coef(REM0.5_twin_and_sibling_categorical))
names(REM0.5_twin_and_sibling_categorical_rC) <- NULL
REM0.5_twin_and_sibling_categorical_rC
...
datMeta_agg0.5_twin_and_sibling_classical <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_twin_and_sibling_classical)
...
# Extract grand rC
REM0.5_twin_and_sibling_classical_rC <- fisherz2r(coef(REM0.5_twin_and_sibling_classical))
names(REM0.5_twin_and_sibling_classical_rC) <- NULL
REM0.5_twin_and_sibling_classical_rC
...
datMeta_agg0.5_twin_and_sibling_dfextremes <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_twin_and_sibling_dfextremes)
...
# Extract grand rC
REM0.5_twin_and_sibling_dfextremes_rC <- fisherz2r(coef(REM0.5_twin_and_sibling_dfextremes))
names(REM0.5_twin_and_sibling_dfextremes_rC) <- NULL
REM0.5_twin_and_sibling_dfextremes_rC
...
datMeta_agg0.5_twin_categorical <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_twin_categorical)
...
# Extract grand rC
REM0.5_twin_categorical_rC <- fisherz2r(coef(REM0.5_twin_categorical))
names(REM0.5_twin_categorical_rC) <- NULL
REM0.5_twin_categorical_rC
...
datMeta_agg0.5_twin_classical <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_twin_classical)
...
# Extract grand rC
REM0.5_twin_classical_rC <- fisherz2r(coef(REM0.5_twin_classical))
names(REM0.5_twin_classical_rC) <- NULL
REM0.5_twin_classical_rC
...
datMeta_agg0.5_twin_dfextremes <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_twin_dfextremes)
...
# Extract grand rC
REM0.5_twin_dfextremes_rC <- fisherz2r(coef(REM0.5_twin_dfextremes))
names(REM0.5_twin_dfextremes_rC) <- NULL
REM0.5_twin_dfextremes_rC
...
designs_rC <- rbind(REM0.5_sibling_categorical_rC,
                    REM0.5_sibling_classical_rC,
                    REM0.5_twin_and_sibling_categorical_rC,
                    REM0.5_twin_and_sibling_dfextremes_rC,
                    REM0.5_twin_and_sibling_classical_rC,
...
designs <- cbind(designs_rC, designs_se, designs_k)
designs
...
datMeta_agg0.5_Aonly <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_Aonly)
...
# Extract grand rC
REM0.5_Aonly_rC <- fisherz2r(coef(REM0.5_Aonly))
names(REM0.5_Aonly_rC) <- NULL
REM0.5_Aonly_rC
...
datMeta_agg0.5_BEST <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_BEST)
...
# Extract grand rC
REM0.5_BEST_rC <- fisherz2r(coef(REM0.5_BEST))
names(REM0.5_BEST_rC) <- NULL
REM0.5_BEST_rC
...
datMeta_agg0.5_DFAonly <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_DFAonly)
...
# Extract grand rC
REM0.5_DFAonly_rC <- fisherz2r(coef(REM0.5_DFAonly))
names(REM0.5_DFAonly_rC) <- NULL
REM0.5_DFAonly_rC
...
datMeta_agg0.5_DFBEST <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_DFBEST)
...
# Extract grand rC
REM0.5_DFBEST_rC <- fisherz2r(coef(REM0.5_DFBEST))
names(REM0.5_DFBEST_rC) <- NULL
REM0.5_DFBEST_rC
...
datMeta_agg0.5_DFFULL <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_DFFULL)
...
# Extract grand rC
REM0.5_DFFULL_rC <- fisherz2r(coef(REM0.5_DFFULL))
names(REM0.5_DFFULL_rC) <- NULL
REM0.5_DFFULL_rC
...
datMeta_agg0.5_FULL <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_FULL)
...
# Extract grand rC
REM0.5_FULL_rC <- fisherz2r(coef(REM0.5_FULL))
names(REM0.5_FULL_rC) <- NULL
REM0.5_FULL_rC
...
datMeta_agg0.5_TC <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_TC)
...
# Extract grand rC
REM0.5_TC_rC <- fisherz2r(coef(REM0.5_TC))
names(REM0.5_TC_rC) <- NULL
REM0.5_TC_rC
...
models_rC <- rbind(REM0.5_Aonly_rC,
                   REM0.5_BEST_rC,
                   REM0.5_FULL_rC,
                   REM0.5_DFAonly_rC,
                   REM0.5_DFBEST_rC,
...
models <- cbind(models_rC, models_se, models_k)
models
...
datMeta_agg0.5_diagnosis <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_diagnosis)
...
# Extract grand rC
REM0.5_diagnosis_rC <- fisherz2r(coef(REM0.5_diagnosis))
names(REM0.5_diagnosis_rC) <- NULL
REM0.5_diagnosis_rC
...
datMeta_agg0.5_parent <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_parent)
...
# Extract grand rC
REM0.5_parent_rC <- fisherz2r(coef(REM0.5_parent))
names(REM0.5_parent_rC) <- NULL
REM0.5_parent_rC
...
datMeta_agg0.5_parent_self <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_parent_self)
...
# Extract grand rC
REM0.5_parent_self_rC <- fisherz2r(coef(REM0.5_parent_self))
names(REM0.5_parent_self_rC) <- NULL
REM0.5_parent_self_rC
...
datMeta_agg0.5_parent_teacher <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_parent_teacher)
...
# Extract grand rC
REM0.5_parent_teacher_rC <- fisherz2r(coef(REM0.5_parent_teacher))
names(REM0.5_parent_teacher_rC) <- NULL
REM0.5_parent_teacher_rC
...
datMeta_agg0.5_researcher <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_researcher)
...
# Extract grand rC
REM0.5_researcher_rC <- fisherz2r(coef(REM0.5_researcher))
names(REM0.5_researcher_rC) <- NULL
REM0.5_researcher_rC
...
datMeta_agg0.5_self <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_self)
...
# Extract grand rC
REM0.5_self_rC <- fisherz2r(coef(REM0.5_self))
names(REM0.5_self_rC) <- NULL
REM0.5_self_rC
...
datMeta_agg0.5_teacher <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_teacher)
...
# Extract grand rC
REM0.5_teacher_rC <- fisherz2r(coef(REM0.5_teacher))
names(REM0.5_teacher_rC) <- NULL
REM0.5_teacher_rC
...
datMeta_agg0.5_test <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_test)
...
# Extract grand rC
REM0.5_test_rC <- fisherz2r(coef(REM0.5_test))
names(REM0.5_test_rC) <- NULL
REM0.5_test_rC
...
raters_rC <- rbind(REM0.5_diagnosis_rC,
                   REM0.5_parent_rC,
                   REM0.5_parent_self_rC,
                   REM0.5_parent_teacher_rC,
                   REM0.5_researcher_rC,
...
raters <- cbind(raters_rC, raters_se, raters_k)
...
datMeta_agg0.5_categorical <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_categorical)
...
# Extract grand rC
REM0.5_categorical_rC <- fisherz2r(coef(REM0.5_categorical))
names(REM0.5_categorical_rC) <- NULL
REM0.5_categorical_rC
...
datMeta_agg0.5_continuous <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_continuous)
...
# Extract grand rC
REM0.5_continuous_rC <- fisherz2r(coef(REM0.5_continuous))
names(REM0.5_continuous_rC) <- NULL
REM0.5_continuous_rC
...
scales_rC <- rbind(REM0.5_categorical_rC,
                   REM0.5_continuous_rC)
...
scales <- cbind(scales_rC, scales_se, scales_k)
scales
...
datMeta_agg0.5_50 <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_50)
...
# Extract grand rC
REM0.5_50_rC <- fisherz2r(coef(REM0.5_50))
names(REM0.5_50_rC) <- NULL
REM0.5_50_rC
...
datMeta_agg0.5_50_75 <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_50_75)
...
# Extract grand rC
REM0.5_50_75_rC <- fisherz2r(coef(REM0.5_50_75))
names(REM0.5_50_75_rC) <- NULL
REM0.5_50_75_rC
...
datMeta_agg0.5_75_100 <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_75_100)
...
# Extract grand rC
REM0.5_75_100_rC <- fisherz2r(coef(REM0.5_75_100))
names(REM0.5_75_100_rC) <- NULL
REM0.5_75_100_rC
...
datMeta_agg0.5_100 <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_100)
...
# Extract grand rC
REM0.5_100_rC <- fisherz2r(coef(REM0.5_100))
names(REM0.5_100_rC) <- NULL
REM0.5_100_rC
...
ethnicities_rC <- rbind(REM0.5_50_rC,
                        REM0.5_50_75_rC,
                        REM0.5_75_100_rC,
                        REM0.5_100_rC)
...
ethnicities <- cbind(ethnicities_rC, ethnicities_se, ethnicities_k)
ethnicities
...
datMeta_agg0.5_0 <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_0)
...
# Extract grand rC
REM0.5_0_rC <- fisherz2r(coef(REM0.5_0))
names(REM0.5_0_rC) <- NULL
REM0.5_0_rC
...
datMeta_agg0.5_1 <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_1)
...
# Extract grand rC
REM0.5_1_rC <- fisherz2r(coef(REM0.5_1))
names(REM0.5_1_rC) <- NULL
REM0.5_1_rC
...
datMeta_agg0.5_2 <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_2)
...
# Extract grand rC
REM0.5_2_rC <- fisherz2r(coef(REM0.5_2))
names(REM0.5_2_rC) <- NULL
REM0.5_2_rC
...
datMeta_agg0.5_3 <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_3)
...
# Extract grand rC
REM0.5_3_rC <- fisherz2r(coef(REM0.5_3))
names(REM0.5_3_rC) <- NULL
REM0.5_3_rC
...
datMeta_agg0.5_4 <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_4)
...
# Extract grand rC
REM0.5_4_rC <- fisherz2r(coef(REM0.5_4))
names(REM0.5_4_rC) <- NULL
REM0.5_4_rC
...
nocovs <- cbind(nocovs_rC, nocovs_se, nocovs_k)
nocovs
...
datMeta_agg0.5_Australia <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_Australia)
...
# Extract grand rC
REM0.5_Australia_rC <- fisherz2r(coef(REM0.5_Australia))
names(REM0.5_Australia_rC) <- NULL
REM0.5_Australia_rC
...
datMeta_agg0.5_Aus_USA_Nor_Swe <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_Aus_USA_Nor_Swe)
...
# Extract grand rC
REM0.5_Aus_USA_Nor_Swe_rC <- fisherz2r(coef(REM0.5_Aus_USA_Nor_Swe))
names(REM0.5_Aus_USA_Nor_Swe_rC) <- NULL
REM0.5_Aus_USA_Nor_Swe_rC
...
datMeta_agg0.5_Canada <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_Canada)
...
# Extract grand rC
REM0.5_Canada_rC <- fisherz2r(coef(REM0.5_Canada))
names(REM0.5_Canada_rC) <- NULL
REM0.5_Canada_rC
...
datMeta_agg0.5_China <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_China)
...
# Extract grand rC
REM0.5_China_rC <- fisherz2r(coef(REM0.5_China))
names(REM0.5_China_rC) <- NULL
REM0.5_China_rC
...
datMeta_agg0.5_Netherlands <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_Netherlands)
...
# Extract grand rC
REM0.5_Netherlands_rC <- fisherz2r(coef(REM0.5_Netherlands))
names(REM0.5_Netherlands_rC) <- NULL
REM0.5_Netherlands_rC
...
datMeta_agg0.5_Norway <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_Norway)
...
# Extract grand rC
REM0.5_Norway_rC <- fisherz2r(coef(REM0.5_Norway))
names(REM0.5_Norway_rC) <- NULL
REM0.5_Norway_rC
...
datMeta_agg0.5_Sweden <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_Sweden)
...
# Extract grand rC
REM0.5_Sweden_rC <- fisherz2r(coef(REM0.5_Sweden))
names(REM0.5_Sweden_rC) <- NULL
REM0.5_Sweden_rC
...
datMeta_agg0.5_UK <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_UK)
...
# Extract grand rC
REM0.5_UK_rC <- fisherz2r(coef(REM0.5_UK))
names(REM0.5_UK_rC) <- NULL
REM0.5_UK_rC
...
datMeta_agg0.5_USA <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_USA)
...
# Extract grand rC
REM0.5_USA_rC <- fisherz2r(coef(REM0.5_USA))
names(REM0.5_USA_rC) <- NULL
REM0.5_USA_rC
...
countries_rC <- rbind(REM0.5_Australia_rC,
                      REM0.5_Aus_USA_Nor_Swe_rC,
                      REM0.5_Canada_rC,
                      REM0.5_China_rC,
                      REM0.5_Netherlands_rC,
...
countries <- cbind(countries_rC, countries_se, countries_k)
countries
...
datMeta_agg0.5_ADHD <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_ADHD)
...
# Extract grand rC
REM0.5_ADHD_rC <- fisherz2r(coef(REM0.5_ADHD))
names(REM0.5_ADHD_rC) <- NULL
REM0.5_ADHD_rC
...
datMeta_agg0.5_ASD <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_ASD)
...
# Extract grand rC
REM0.5_ASD_rC <- fisherz2r(coef(REM0.5_ASD))
names(REM0.5_ASD_rC) <- NULL
REM0.5_ASD_rC
...
datMeta_agg0.5_CMD <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_CMD)
...
# Extract grand rC
REM0.5_CMD_rC <- fisherz2r(coef(REM0.5_CMD))
names(REM0.5_CMD_rC) <- NULL
REM0.5_CMD_rC
...
datMeta_agg0.5_SLD <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_SLD)
...
# Extract grand rC
REM0.5_SLD_rC <- fisherz2r(coef(REM0.5_SLD))
names(REM0.5_SLD_rC) <- NULL
REM0.5_SLD_rC
...
datMeta_agg0.5_LD <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_LD)
...
# Extract grand rC
REM0.5_LD_rC <- fisherz2r(coef(REM0.5_LD))
names(REM0.5_LD_rC) <- NULL
REM0.5_LD_rC
...
datMeta_agg0.5_MD <- agg(id=Full.Ref, es=FZ_rC, var=rC_SE, cor=0.5, data=datMeta_MD)
...
# Extract grand rC
REM0.5_MD_rC <- fisherz2r(coef(REM0.5_MD))
names(REM0.5_MD_rC) <- NULL
REM0.5_MD_rC
...
disorders_rC <- rbind(REM0.5_SLD_rC,
                      REM0.5_ADHD_rC,
                      REM0.5_ASD_rC,
                      REM0.5_CMD_rC,
                      REM0.5_MD_rC,
...
disorders <- cbind(disorders_rC, disorders_se, disorders_k)
disorders
