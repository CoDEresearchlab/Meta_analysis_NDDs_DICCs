...
REM0.5_childhood_rE <- NA                   
REM0.5_middlechildhood_rE <- NA             
REM0.5_adolescence_rE <- NA                 
REM0.5_childhood_middlechildhood_rE <- NA   
REM0.5_childhood_adolescence_rE <- NA       
REM0.5_middlechildhood_adolescence_rE <- NA 
REM0.5_sibling_categorical_rE <- NA         
REM0.5_sibling_classical_rE <- NA           
REM0.5_twin_and_sibling_categorical_rE <- NA
REM0.5_twin_and_sibling_dfextremes_rE <- NA 
REM0.5_twin_and_sibling_classical_rE <- NA  
REM0.5_twin_categorical_rE <- NA            
REM0.5_twin_dfextremes_rE <- NA             
REM0.5_twin_classical_rE <- NA              
REM0.5_Aonly_rE <- NA                       
REM0.5_BEST_rE <- NA                        
REM0.5_FULL_rE <- NA                        
REM0.5_DFAonly_rE <- NA                     
REM0.5_DFBEST_rE <- NA                      
REM0.5_DFFULL_rE <- NA                      
REM0.5_TC_rE <- NA                          
REM0.5_diagnosis_rE <- NA                   
REM0.5_parent_rE <- NA                      
REM0.5_parent_self_rE <- NA                 
REM0.5_parent_teacher_rE <- NA              
REM0.5_researcher_rE <- NA                  
REM0.5_self_rE <- NA                        
REM0.5_teacher_rE <- NA                     
REM0.5_test_rE <- NA                        
REM0.5_categorical_rE <- NA                 
REM0.5_continuous_rE <- NA                  
REM0.5_50_rE <- NA                          
REM0.5_50_75_rE <- NA                       
REM0.5_75_100_rE <- NA                      
REM0.5_100_rE <- NA                         
...
REM0.5_3_rE <- NA                           
REM0.5_4_rE <- NA                           
REM0.5_Australia_rE <- NA                   
REM0.5_Aus_USA_Nor_Swe_rE <- NA             
REM0.5_Canada_rE <- NA                      
REM0.5_China_rE <- NA                       
REM0.5_Netherlands_rE <- NA                 
REM0.5_Norway_rE <- NA                      
REM0.5_Sweden_rE <- NA                      
REM0.5_UK_rE <- NA                          
REM0.5_USA_rE <- NA    
...
# ============= Compute effect size and variance -- Converting rE into Fisher's Z ==========================
# ============= Treat rE as correlation and convert to Fisher's Z (SE will be used as variance) =============
...
datMeta_agg0.5 <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta)
datMeta_agg0.3 <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.3, data=datMeta)
datMeta_agg0.9 <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.9, data=datMeta)
...
# Extract grand rE
REM0.5_nocov_rE <- fisherz2r(coef(REM0.5_nocov))
names(REM0.5_nocov_rE) <- NULL
REM0.5_nocov_rE

REM0.3_nocov_rE <- fisherz2r(coef(REM0.3_nocov))
names(REM0.3_nocov_rE) <- NULL
REM0.3_nocov_rE

REM0.9_nocov_rE <- fisherz2r(coef(REM0.9_nocov))
names(REM0.9_nocov_rE) <- NULL
REM0.9_nocov_rE

cbind(REM0.5_nocov_rE, REM0.3_nocov_rE, REM0.9_nocov_rE) #No difference :)
...
datMeta_agg0.5_cohort <- agg(id=Cohort, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta)
datMeta_agg0.3_cohort <- agg(id=Cohort, es=FZ_rE, var=rE_SE, cor=0.3, data=datMeta)
datMeta_agg0.9_cohort <- agg(id=Cohort, es=FZ_rE, var=rE_SE, cor=0.9, data=datMeta)
...
# Extract grand rE
REM0.5_cohort_nocov_rE <- fisherz2r(coef(REM0.5_cohort_nocov))
names(REM0.5_cohort_nocov_rE) <- NULL
REM0.5_cohort_nocov_rE

REM0.3_cohort_nocov_rE <- fisherz2r(coef(REM0.3_cohort_nocov))
names(REM0.3_cohort_nocov_rE) <- NULL
REM0.3_cohort_nocov_rE

REM0.9_cohort_nocov_rE <- fisherz2r(coef(REM0.9_cohort_nocov))
names(REM0.9_cohort_nocov_rE) <- NULL
REM0.9_cohort_nocov_rE

cbind(REM0.5_cohort_nocov_rE, REM0.3_cohort_nocov_rE, REM0.9_cohort_nocov_rE) #No difference :)
...
datMeta_agg0.5_country <- agg(id=Cohort_country1, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta)
datMeta_agg0.3_country <- agg(id=Cohort_country1, es=FZ_rE, var=rE_SE, cor=0.3, data=datMeta)
datMeta_agg0.9_country <- agg(id=Cohort_country1, es=FZ_rE, var=rE_SE, cor=0.9, data=datMeta)
...
# Extract grand rE
REM0.5_country_nocov_rE <- fisherz2r(coef(REM0.5_country_nocov))
names(REM0.5_country_nocov_rE) <- NULL
REM0.5_country_nocov_rE

REM0.3_country_nocov_rE <- fisherz2r(coef(REM0.3_country_nocov))
names(REM0.3_country_nocov_rE) <- NULL
REM0.3_country_nocov_rE

REM0.9_country_nocov_rE <- fisherz2r(coef(REM0.9_country_nocov))
names(REM0.9_country_nocov_rE) <- NULL
REM0.9_country_nocov_rE

cbind(REM0.5_country_nocov_rE, REM0.3_country_nocov_rE, REM0.9_country_nocov_rE) #No difference :)
...
datMeta_agg0.5_childhood <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_childhood)
...
# Extract grand rE
REM0.5_childhood_rE <- fisherz2r(coef(REM0.5_childhood))
names(REM0.5_childhood_rE) <- NULL
REM0.5_childhood_rE
...
datMeta_agg0.5_middlechildhood <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_middlechildhood)
...
# Extract grand rE
REM0.5_middlechildhood_rE <- fisherz2r(coef(REM0.5_middlechildhood))
names(REM0.5_middlechildhood_rE) <- NULL
REM0.5_middlechildhood_rE
...
datMeta_agg0.5_adolescence <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_adolescence)
...
# Extract grand rE
REM0.5_adolescence_rE <- fisherz2r(coef(REM0.5_adolescence))
names(REM0.5_adolescence_rE) <- NULL
REM0.5_adolescence_rE
...
datMeta_agg0.5_childhood_middlechildhood <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_childhood_middlechildhood)
...
# Extract grand rE
REM0.5_childhood_middlechildhood_rE <- fisherz2r(coef(REM0.5_childhood_middlechildhood))
names(REM0.5_childhood_middlechildhood_rE) <- NULL
REM0.5_childhood_middlechildhood_rE
...
datMeta_agg0.5_middlechildhood_adolescence <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_middlechildhood_adolescence)
...
# Extract grand rE
REM0.5_middlechildhood_adolescence_rE <- fisherz2r(coef(REM0.5_middlechildhood_adolescence))
names(REM0.5_middlechildhood_adolescence_rE) <- NULL
REM0.5_middlechildhood_adolescence_rE
...
datMeta_agg0.5_childhood_adolescence <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_childhood_adolescence)
...
# Extract grand rE
REM0.5_childhood_adolescence_rE <- fisherz2r(coef(REM0.5_childhood_adolescence))
names(REM0.5_childhood_adolescence_rE) <- NULL
REM0.5_childhood_adolescence_rE
...
ages_rE <- rbind(REM0.5_childhood_rE,
                 REM0.5_middlechildhood_rE,
                 REM0.5_adolescence_rE,
                 REM0.5_childhood_middlechildhood_rE,
                 REM0.5_childhood_adolescence_rE,
...
ages <- cbind(ages_rE, ages_se, ages_k)
...
datMeta_agg0.5_sibling_categorical <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_sibling_categorical)
...
# Extract grand rE
REM0.5_sibling_categorical_rE <- fisherz2r(coef(REM0.5_sibling_categorical))
names(REM0.5_sibling_categorical_rE) <- NULL
REM0.5_sibling_categorical_rE
...
datMeta_agg0.5_sibling_classical <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_sibling_classical)
...
# Extract grand rE
REM0.5_sibling_classical_rE <- fisherz2r(coef(REM0.5_sibling_classical))
names(REM0.5_sibling_classical_rE) <- NULL
REM0.5_sibling_classical_rE
...
datMeta_agg0.5_twin_and_sibling_categorical <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_twin_and_sibling_categorical)
...
# Extract grand rE
REM0.5_twin_and_sibling_categorical_rE <- fisherz2r(coef(REM0.5_twin_and_sibling_categorical))
names(REM0.5_twin_and_sibling_categorical_rE) <- NULL
REM0.5_twin_and_sibling_categorical_rE
...
datMeta_agg0.5_twin_and_sibling_classical <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_twin_and_sibling_classical)
...
# Extract grand rE
REM0.5_twin_and_sibling_classical_rE <- fisherz2r(coef(REM0.5_twin_and_sibling_classical))
names(REM0.5_twin_and_sibling_classical_rE) <- NULL
REM0.5_twin_and_sibling_classical_rE
...
datMeta_agg0.5_twin_and_sibling_dfextremes <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_twin_and_sibling_dfextremes)
...
# Extract grand rE
REM0.5_twin_and_sibling_dfextremes_rE <- fisherz2r(coef(REM0.5_twin_and_sibling_dfextremes))
names(REM0.5_twin_and_sibling_dfextremes_rE) <- NULL
REM0.5_twin_and_sibling_dfextremes_rE
...
datMeta_agg0.5_twin_categorical <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_twin_categorical)
...
# Extract grand rE
REM0.5_twin_categorical_rE <- fisherz2r(coef(REM0.5_twin_categorical))
names(REM0.5_twin_categorical_rE) <- NULL
REM0.5_twin_categorical_rE
...
datMeta_agg0.5_twin_classical <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_twin_classical)
...
# Extract grand rE
REM0.5_twin_classical_rE <- fisherz2r(coef(REM0.5_twin_classical))
names(REM0.5_twin_classical_rE) <- NULL
REM0.5_twin_classical_rE
...
datMeta_agg0.5_twin_dfextremes <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_twin_dfextremes)
...
# Extract grand rE
REM0.5_twin_dfextremes_rE <- fisherz2r(coef(REM0.5_twin_dfextremes))
names(REM0.5_twin_dfextremes_rE) <- NULL
REM0.5_twin_dfextremes_rE
...
designs_rE <- rbind(REM0.5_sibling_categorical_rE,
                    REM0.5_sibling_classical_rE,
                    REM0.5_twin_and_sibling_categorical_rE,
                    REM0.5_twin_and_sibling_dfextremes_rE,
                    REM0.5_twin_and_sibling_classical_rE,
...
designs <- cbind(designs_rE, designs_se, designs_k)
designs
...
datMeta_agg0.5_Aonly <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_Aonly)
...
# Extract grand rE
REM0.5_Aonly_rE <- fisherz2r(coef(REM0.5_Aonly))
names(REM0.5_Aonly_rE) <- NULL
REM0.5_Aonly_rE
...
datMeta_agg0.5_BEST <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_BEST)
...
# Extract grand rE
REM0.5_BEST_rE <- fisherz2r(coef(REM0.5_BEST))
names(REM0.5_BEST_rE) <- NULL
REM0.5_BEST_rE
...
datMeta_agg0.5_DFAonly <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_DFAonly)
...
# Extract grand rE
REM0.5_DFAonly_rE <- fisherz2r(coef(REM0.5_DFAonly))
names(REM0.5_DFAonly_rE) <- NULL
REM0.5_DFAonly_rE
...
datMeta_agg0.5_DFBEST <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_DFBEST)
...
# Extract grand rE
REM0.5_DFBEST_rE <- fisherz2r(coef(REM0.5_DFBEST))
names(REM0.5_DFBEST_rE) <- NULL
REM0.5_DFBEST_rE
...
datMeta_agg0.5_DFFULL <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_DFFULL)
...
# Extract grand rE
REM0.5_DFFULL_rE <- fisherz2r(coef(REM0.5_DFFULL))
names(REM0.5_DFFULL_rE) <- NULL
REM0.5_DFFULL_rE
...
datMeta_agg0.5_FULL <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_FULL)
...
# Extract grand rE
REM0.5_FULL_rE <- fisherz2r(coef(REM0.5_FULL))
names(REM0.5_FULL_rE) <- NULL
REM0.5_FULL_rE
...
datMeta_agg0.5_TC <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_TC)
...
# Extract grand rE
REM0.5_TC_rE <- fisherz2r(coef(REM0.5_TC))
names(REM0.5_TC_rE) <- NULL
REM0.5_TC_rE
...
models_rE <- rbind(REM0.5_Aonly_rE,
                   REM0.5_BEST_rE,
                   REM0.5_FULL_rE,
                   REM0.5_DFAonly_rE,
                   REM0.5_DFBEST_rE,
...
models <- cbind(models_rE, models_se, models_k)
models
...
datMeta_agg0.5_diagnosis <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_diagnosis)
...
# Extract grand rE
REM0.5_diagnosis_rE <- fisherz2r(coef(REM0.5_diagnosis))
names(REM0.5_diagnosis_rE) <- NULL
REM0.5_diagnosis_rE
...
datMeta_agg0.5_parent <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_parent)
...
# Extract grand rE
REM0.5_parent_rE <- fisherz2r(coef(REM0.5_parent))
names(REM0.5_parent_rE) <- NULL
REM0.5_parent_rE
...
datMeta_agg0.5_parent_self <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_parent_self)
...
# Extract grand rE
REM0.5_parent_self_rE <- fisherz2r(coef(REM0.5_parent_self))
names(REM0.5_parent_self_rE) <- NULL
REM0.5_parent_self_rE
...
datMeta_agg0.5_parent_teacher <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_parent_teacher)
...
# Extract grand rE
REM0.5_parent_teacher_rE <- fisherz2r(coef(REM0.5_parent_teacher))
names(REM0.5_parent_teacher_rE) <- NULL
REM0.5_parent_teacher_rE
...
datMeta_agg0.5_researcher <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_researcher)
...
# Extract grand rE
REM0.5_researcher_rE <- fisherz2r(coef(REM0.5_researcher))
names(REM0.5_researcher_rE) <- NULL
REM0.5_researcher_rE
...
datMeta_agg0.5_self <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_self)
...
# Extract grand rE
REM0.5_self_rE <- fisherz2r(coef(REM0.5_self))
names(REM0.5_self_rE) <- NULL
REM0.5_self_rE
...
datMeta_agg0.5_teacher <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_teacher)
...
# Extract grand rE
REM0.5_teacher_rE <- fisherz2r(coef(REM0.5_teacher))
names(REM0.5_teacher_rE) <- NULL
REM0.5_teacher_rE
...
datMeta_agg0.5_test <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_test)
...
# Extract grand rE
REM0.5_test_rE <- fisherz2r(coef(REM0.5_test))
names(REM0.5_test_rE) <- NULL
REM0.5_test_rE
...
raters_rE <- rbind(REM0.5_diagnosis_rE,
                   REM0.5_parent_rE,
                   REM0.5_parent_self_rE,
                   REM0.5_parent_teacher_rE,
                   REM0.5_researcher_rE,
...
raters <- cbind(raters_rE, raters_se, raters_k)
...
datMeta_agg0.5_categorical <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_categorical)
...
# Extract grand rE
REM0.5_categorical_rE <- fisherz2r(coef(REM0.5_categorical))
names(REM0.5_categorical_rE) <- NULL
REM0.5_categorical_rE
...
datMeta_agg0.5_continuous <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_continuous)
...
# Extract grand rE
REM0.5_continuous_rE <- fisherz2r(coef(REM0.5_continuous))
names(REM0.5_continuous_rE) <- NULL
REM0.5_continuous_rE
...
scales_rE <- rbind(REM0.5_categorical_rE,
                   REM0.5_continuous_rE)
...
scales <- cbind(scales_rE, scales_se, scales_k)
scales
...
datMeta_agg0.5_50 <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_50)
...
# Extract grand rE
REM0.5_50_rE <- fisherz2r(coef(REM0.5_50))
names(REM0.5_50_rE) <- NULL
REM0.5_50_rE
...
datMeta_agg0.5_50_75 <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_50_75)
...
# Extract grand rE
REM0.5_50_75_rE <- fisherz2r(coef(REM0.5_50_75))
names(REM0.5_50_75_rE) <- NULL
REM0.5_50_75_rE
...
datMeta_agg0.5_75_100 <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_75_100)
...
# Extract grand rE
REM0.5_75_100_rE <- fisherz2r(coef(REM0.5_75_100))
names(REM0.5_75_100_rE) <- NULL
REM0.5_75_100_rE
...
datMeta_agg0.5_100 <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_100)
...
# Extract grand rE
REM0.5_100_rE <- fisherz2r(coef(REM0.5_100))
names(REM0.5_100_rE) <- NULL
REM0.5_100_rE
...
ethnicities_rE <- rbind(REM0.5_50_rE,
                        REM0.5_50_75_rE,
                        REM0.5_75_100_rE,
                        REM0.5_100_rE)
...
ethnicities <- cbind(ethnicities_rE, ethnicities_se, ethnicities_k)
ethnicities
...
datMeta_agg0.5_0 <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_0)
...
# Extract grand rE
REM0.5_0_rE <- fisherz2r(coef(REM0.5_0))
names(REM0.5_0_rE) <- NULL
REM0.5_0_rE
...
datMeta_agg0.5_1 <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_1)
...
# Extract grand rE
REM0.5_1_rE <- fisherz2r(coef(REM0.5_1))
names(REM0.5_1_rE) <- NULL
REM0.5_1_rE
...
datMeta_agg0.5_2 <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_2)
...
# Extract grand rE
REM0.5_2_rE <- fisherz2r(coef(REM0.5_2))
names(REM0.5_2_rE) <- NULL
REM0.5_2_rE
...
datMeta_agg0.5_3 <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_3)
...
# Extract grand rE
REM0.5_3_rE <- fisherz2r(coef(REM0.5_3))
names(REM0.5_3_rE) <- NULL
REM0.5_3_rE
...
datMeta_agg0.5_4 <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_4)
...
# Extract grand rE
REM0.5_4_rE <- fisherz2r(coef(REM0.5_4))
names(REM0.5_4_rE) <- NULL
REM0.5_4_rE
...
nocovs <- cbind(nocovs_rE, nocovs_se, nocovs_k)
nocovs
...
datMeta_agg0.5_Australia <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_Australia)
...
# Extract grand rE
REM0.5_Australia_rE <- fisherz2r(coef(REM0.5_Australia))
names(REM0.5_Australia_rE) <- NULL
REM0.5_Australia_rE
...
datMeta_agg0.5_Aus_USA_Nor_Swe <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_Aus_USA_Nor_Swe)
...
# Extract grand rE
REM0.5_Aus_USA_Nor_Swe_rE <- fisherz2r(coef(REM0.5_Aus_USA_Nor_Swe))
names(REM0.5_Aus_USA_Nor_Swe_rE) <- NULL
REM0.5_Aus_USA_Nor_Swe_rE
...
datMeta_agg0.5_Canada <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_Canada)
...
# Extract grand rE
REM0.5_Canada_rE <- fisherz2r(coef(REM0.5_Canada))
names(REM0.5_Canada_rE) <- NULL
REM0.5_Canada_rE
...
datMeta_agg0.5_China <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_China)
...
# Extract grand rE
REM0.5_China_rE <- fisherz2r(coef(REM0.5_China))
names(REM0.5_China_rE) <- NULL
REM0.5_China_rE
...
datMeta_agg0.5_Netherlands <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_Netherlands)
...
# Extract grand rE
REM0.5_Netherlands_rE <- fisherz2r(coef(REM0.5_Netherlands))
names(REM0.5_Netherlands_rE) <- NULL
REM0.5_Netherlands_rE
...
datMeta_agg0.5_Norway <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_Norway)
...
# Extract grand rE
REM0.5_Norway_rE <- fisherz2r(coef(REM0.5_Norway))
names(REM0.5_Norway_rE) <- NULL
REM0.5_Norway_rE
...
datMeta_agg0.5_Sweden <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_Sweden)
...
# Extract grand rE
REM0.5_Sweden_rE <- fisherz2r(coef(REM0.5_Sweden))
names(REM0.5_Sweden_rE) <- NULL
REM0.5_Sweden_rE
...
datMeta_agg0.5_UK <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_UK)
...
# Extract grand rE
REM0.5_UK_rE <- fisherz2r(coef(REM0.5_UK))
names(REM0.5_UK_rE) <- NULL
REM0.5_UK_rE
...
datMeta_agg0.5_USA <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_USA)
...
# Extract grand rE
REM0.5_USA_rE <- fisherz2r(coef(REM0.5_USA))
names(REM0.5_USA_rE) <- NULL
REM0.5_USA_rE
...
countries_rE <- rbind(REM0.5_Australia_rE,
                      REM0.5_Aus_USA_Nor_Swe_rE,
                      REM0.5_Canada_rE,
                      REM0.5_China_rE,
                      REM0.5_Netherlands_rE,
...
countries <- cbind(countries_rE, countries_se, countries_k)
countries
...
datMeta_agg0.5_ADHD <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_ADHD)
...
# Extract grand rE
REM0.5_ADHD_rE <- fisherz2r(coef(REM0.5_ADHD))
names(REM0.5_ADHD_rE) <- NULL
REM0.5_ADHD_rE
...
datMeta_agg0.5_ASD <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_ASD)
...
# Extract grand rE
REM0.5_ASD_rE <- fisherz2r(coef(REM0.5_ASD))
names(REM0.5_ASD_rE) <- NULL
REM0.5_ASD_rE
...
datMeta_agg0.5_CMD <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_CMD)
...
# Extract grand rE
REM0.5_CMD_rE <- fisherz2r(coef(REM0.5_CMD))
names(REM0.5_CMD_rE) <- NULL
REM0.5_CMD_rE
...
datMeta_agg0.5_SLD <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_SLD)
...
# Extract grand rE
REM0.5_SLD_rE <- fisherz2r(coef(REM0.5_SLD))
names(REM0.5_SLD_rE) <- NULL
REM0.5_SLD_rE
...
datMeta_agg0.5_LD <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_LD)
...
# Extract grand rE
REM0.5_LD_rE <- fisherz2r(coef(REM0.5_LD))
names(REM0.5_LD_rE) <- NULL
REM0.5_LD_rE
...
datMeta_agg0.5_MD <- agg(id=Full.Ref, es=FZ_rE, var=rE_SE, cor=0.5, data=datMeta_MD)
...
# Extract grand rE
REM0.5_MD_rE <- fisherz2r(coef(REM0.5_MD))
names(REM0.5_MD_rE) <- NULL
REM0.5_MD_rE
...
disorders_rE <- rbind(REM0.5_SLD_rE,
                      REM0.5_ADHD_rE,
                      REM0.5_ASD_rE,
                      REM0.5_CMD_rE,
                      REM0.5_MD_rE,
...
disorders <- cbind(disorders_rE, disorders_se, disorders_k)
disorders
